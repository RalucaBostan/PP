...
import cnames.structs.IDirect3DDevice9
...
fun SDL_ultoa(value: UInt, str: CValuesRef<ByteVar>?, radix: Int): CPointer<ByteVar>? {
    memScoped {
...
fun SDL_strtol(@CCall.CString str: String?, endp: CValuesRef<CPointerVar<ByteVar>>?, base: Int): Int {
    memScoped {
        return kniBridge46(str?.cstr?.getPointer(memScope).rawValue, endp?.getPointer(memScope).rawValue, base)
    }
}

fun SDL_strtoul(@CCall.CString str: String?, endp: CValuesRef<CPointerVar<ByteVar>>?, base: Int): UInt {
    memScoped {
...
fun SDL_RegisterApp(name: CValuesRef<ByteVar>?, style: Uint32, hInst: CValuesRef<*>?): Int {
    memScoped {
        return kniBridge100(name?.getPointer(memScope).rawValue, style, hInst?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_ReportAssertion(arg0: CValuesRef<SDL_AssertData>?, @CCall.CString arg1: String?, @CCall.CString arg2: String?, arg3: Int): SDL_AssertState {
    memScoped {
        return SDL_AssertState.byValue(kniBridge102(arg0?.getPointer(memScope).rawValue, arg1?.cstr?.getPointer(memScope).rawValue, arg2?.cstr?.getPointer(memScope).rawValue, arg3))
    }
}

fun SDL_SetAssertionHandler(handler: SDL_AssertionHandler?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge103(handler.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetDefaultAssertionHandler(): SDL_AssertionHandler? {
    return interpretCPointer<CFunction<(CPointer<SDL_AssertData>?, COpaquePointer?) -> SDL_AssertState>>(kniBridge104())
}

fun SDL_GetAssertionHandler(puserdata: CValuesRef<COpaquePointerVar>?): SDL_AssertionHandler? {
    memScoped {
        return interpretCPointer<CFunction<(CPointer<SDL_AssertData>?, COpaquePointer?) -> SDL_AssertState>>(kniBridge105(puserdata?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetAssertionReport(): CPointer<SDL_AssertData>? {
    return interpretCPointer<SDL_AssertData>(kniBridge106())
}
...
fun SDL_AtomicLock(lock: CValuesRef<SDL_SpinLockVar>?): Unit {
    memScoped {
        return kniBridge109(lock?.getPointer(memScope).rawValue)
    }
}

fun SDL_AtomicUnlock(lock: CValuesRef<SDL_SpinLockVar>?): Unit {
    memScoped {
        return kniBridge110(lock?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_AtomicCAS(a: CValuesRef<SDL_atomic_t>?, oldval: Int, newval: Int): SDL_bool {
    memScoped {
        return kniBridge113(a?.getPointer(memScope).rawValue, oldval, newval)
    }
}
...
fun SDL_AtomicGet(a: CValuesRef<SDL_atomic_t>?): Int {
    memScoped {
        return kniBridge115(a?.getPointer(memScope).rawValue)
    }
}

fun SDL_AtomicAdd(a: CValuesRef<SDL_atomic_t>?, v: Int): Int {
    memScoped {
        return kniBridge116(a?.getPointer(memScope).rawValue, v)
    }
}

fun SDL_AtomicCASPtr(a: CValuesRef<COpaquePointerVar>?, oldval: CValuesRef<*>?, newval: CValuesRef<*>?): SDL_bool {
    memScoped {
        return kniBridge117(a?.getPointer(memScope).rawValue, oldval?.getPointer(memScope).rawValue, newval?.getPointer(memScope).rawValue)
    }
}

fun SDL_AtomicSetPtr(a: CValuesRef<COpaquePointerVar>?, v: CValuesRef<*>?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge118(a?.getPointer(memScope).rawValue, v?.getPointer(memScope).rawValue))
    }
}

fun SDL_AtomicGetPtr(a: CValuesRef<COpaquePointerVar>?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge119(a?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_GetError(): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge120())
}
...
fun SDL_Error(code: SDL_errorcode): Int {
    return kniBridge122(code.value)
}
...
fun SDL_Swap64(x: Uint64): Uint64 {
    return kniBridge125(x)
}

fun SDL_SwapFloat(x: Float): Float {
    return kniBridge126(x)
}

fun SDL_CreateMutex(): CPointer<SDL_mutex>? {
    return interpretCPointer<SDL_mutex>(kniBridge127())
}
...
fun SDL_UnlockMutex(mutex: CValuesRef<SDL_mutex>?): Int {
    memScoped {
        return kniBridge130(mutex?.getPointer(memScope).rawValue)
    }
}

fun SDL_DestroyMutex(mutex: CValuesRef<SDL_mutex>?): Unit {
    memScoped {
        return kniBridge131(mutex?.getPointer(memScope).rawValue)
    }
}

fun SDL_CreateSemaphore(initial_value: Uint32): CPointer<SDL_sem>? {
    return interpretCPointer<SDL_sem>(kniBridge132(initial_value))
}
...
fun SDL_SemWait(sem: CValuesRef<SDL_sem>?): Int {
    memScoped {
        return kniBridge134(sem?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_SemWaitTimeout(sem: CValuesRef<SDL_sem>?, ms: Uint32): Int {
    memScoped {
        return kniBridge136(sem?.getPointer(memScope).rawValue, ms)
    }
}

fun SDL_SemPost(sem: CValuesRef<SDL_sem>?): Int {
    memScoped {
        return kniBridge137(sem?.getPointer(memScope).rawValue)
    }
}

fun SDL_SemValue(sem: CValuesRef<SDL_sem>?): Uint32 {
    memScoped {
        return kniBridge138(sem?.getPointer(memScope).rawValue)
    }
}

fun SDL_CreateCond(): CPointer<SDL_cond>? {
    return interpretCPointer<SDL_cond>(kniBridge139())
}
...
fun SDL_CondSignal(cond: CValuesRef<SDL_cond>?): Int {
    memScoped {
        return kniBridge141(cond?.getPointer(memScope).rawValue)
    }
}

fun SDL_CondBroadcast(cond: CValuesRef<SDL_cond>?): Int {
    memScoped {
        return kniBridge142(cond?.getPointer(memScope).rawValue)
    }
}

fun SDL_CondWait(cond: CValuesRef<SDL_cond>?, mutex: CValuesRef<SDL_mutex>?): Int {
    memScoped {
        return kniBridge143(cond?.getPointer(memScope).rawValue, mutex?.getPointer(memScope).rawValue)
    }
}

fun SDL_CondWaitTimeout(cond: CValuesRef<SDL_cond>?, mutex: CValuesRef<SDL_mutex>?, ms: Uint32): Int {
    memScoped {
        return kniBridge144(cond?.getPointer(memScope).rawValue, mutex?.getPointer(memScope).rawValue, ms)
    }
}

@Deprecated("Unable to import this declaration", level = DeprecationLevel.ERROR)
fun SDL_CreateThread(fn: SDL_ThreadFunction?, @CCall.CString name: String?, data: CValuesRef<*>?, pfnBeginThread: pfnSDL_CurrentBeginThread?, pfnEndThread: pfnSDL_CurrentEndThread?): CPointer<SDL_Thread>? = throw UnsupportedOperationException()

@Deprecated("Unable to import this declaration", level = DeprecationLevel.ERROR)
fun SDL_CreateThreadWithStackSize(fn: CPointer<CFunction<(COpaquePointer?) -> Int>>?, @CCall.CString name: String?, stacksize: size_t, data: CValuesRef<*>?, pfnBeginThread: pfnSDL_CurrentBeginThread?, pfnEndThread: pfnSDL_CurrentEndThread?): CPointer<SDL_Thread>? = throw UnsupportedOperationException()

fun SDL_GetThreadName(thread: CValuesRef<SDL_Thread>?): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge147(thread?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_GetThreadID(thread: CValuesRef<SDL_Thread>?): SDL_threadID {
    memScoped {
        return kniBridge149(thread?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetThreadPriority(priority: SDL_ThreadPriority): Int {
    return kniBridge150(priority.value)
}

fun SDL_WaitThread(thread: CValuesRef<SDL_Thread>?, status: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge151(thread?.getPointer(memScope).rawValue, status?.getPointer(memScope).rawValue)
    }
}

fun SDL_DetachThread(thread: CValuesRef<SDL_Thread>?): Unit {
    memScoped {
        return kniBridge152(thread?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_TLSGet(id: SDL_TLSID): COpaquePointer? {
    return interpretCPointer<COpaque>(kniBridge154(id))
}

fun SDL_TLSSet(id: SDL_TLSID, value: CValuesRef<*>?, destructor: CPointer<CFunction<(COpaquePointer?) -> Unit>>?): Int {
    memScoped {
        return kniBridge155(id, value?.getPointer(memScope).rawValue, destructor.rawValue)
    }
}

fun SDL_RWFromFile(@CCall.CString file: String?, @CCall.CString mode: String?): CPointer<SDL_RWops>? {
    memScoped {
        return interpretCPointer<SDL_RWops>(kniBridge156(file?.cstr?.getPointer(memScope).rawValue, mode?.cstr?.getPointer(memScope).rawValue))
    }
}

fun SDL_RWFromFP(fp: CValuesRef<*>?, autoclose: SDL_bool): CPointer<SDL_RWops>? {
    memScoped {
        return interpretCPointer<SDL_RWops>(kniBridge157(fp?.getPointer(memScope).rawValue, autoclose))
    }
}

fun SDL_RWFromMem(mem: CValuesRef<*>?, size: Int): CPointer<SDL_RWops>? {
    memScoped {
        return interpretCPointer<SDL_RWops>(kniBridge158(mem?.getPointer(memScope).rawValue, size))
    }
}

fun SDL_RWFromConstMem(mem: CValuesRef<*>?, size: Int): CPointer<SDL_RWops>? {
    memScoped {
        return interpretCPointer<SDL_RWops>(kniBridge159(mem?.getPointer(memScope).rawValue, size))
    }
}

fun SDL_AllocRW(): CPointer<SDL_RWops>? {
    return interpretCPointer<SDL_RWops>(kniBridge160())
}

fun SDL_FreeRW(area: CValuesRef<SDL_RWops>?): Unit {
    memScoped {
        return kniBridge161(area?.getPointer(memScope).rawValue)
    }
}

fun SDL_LoadFile_RW(src: CValuesRef<SDL_RWops>?, datasize: CValuesRef<size_tVar>?, freesrc: Int): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge162(src?.getPointer(memScope).rawValue, datasize?.getPointer(memScope).rawValue, freesrc))
    }
}

fun SDL_ReadU8(src: CValuesRef<SDL_RWops>?): Uint8 {
    memScoped {
        return kniBridge163(src?.getPointer(memScope).rawValue)
    }
}

fun SDL_ReadLE16(src: CValuesRef<SDL_RWops>?): Uint16 {
    memScoped {
        return kniBridge164(src?.getPointer(memScope).rawValue)
    }
}

fun SDL_ReadBE16(src: CValuesRef<SDL_RWops>?): Uint16 {
    memScoped {
        return kniBridge165(src?.getPointer(memScope).rawValue)
    }
}

fun SDL_ReadLE32(src: CValuesRef<SDL_RWops>?): Uint32 {
    memScoped {
        return kniBridge166(src?.getPointer(memScope).rawValue)
    }
}

fun SDL_ReadBE32(src: CValuesRef<SDL_RWops>?): Uint32 {
    memScoped {
        return kniBridge167(src?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_WriteU8(dst: CValuesRef<SDL_RWops>?, value: Uint8): size_t {
    memScoped {
        return kniBridge170(dst?.getPointer(memScope).rawValue, value)
    }
}

fun SDL_WriteLE16(dst: CValuesRef<SDL_RWops>?, value: Uint16): size_t {
    memScoped {
        return kniBridge171(dst?.getPointer(memScope).rawValue, value)
    }
}

fun SDL_WriteBE16(dst: CValuesRef<SDL_RWops>?, value: Uint16): size_t {
    memScoped {
        return kniBridge172(dst?.getPointer(memScope).rawValue, value)
    }
}

fun SDL_WriteLE32(dst: CValuesRef<SDL_RWops>?, value: Uint32): size_t {
    memScoped {
        return kniBridge173(dst?.getPointer(memScope).rawValue, value)
    }
}

fun SDL_WriteBE32(dst: CValuesRef<SDL_RWops>?, value: Uint32): size_t {
    memScoped {
        return kniBridge174(dst?.getPointer(memScope).rawValue, value)
    }
}
...
fun SDL_GetAudioDriver(index: Int): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge178(index))
}

fun SDL_AudioInit(@CCall.CString driver_name: String?): Int {
    memScoped {
        return kniBridge179(driver_name?.cstr?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GetCurrentAudioDriver(): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge181())
}

fun SDL_OpenAudio(desired: CValuesRef<SDL_AudioSpec>?, obtained: CValuesRef<SDL_AudioSpec>?): Int {
    memScoped {
        return kniBridge182(desired?.getPointer(memScope).rawValue, obtained?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetNumAudioDevices(iscapture: Int): Int {
    return kniBridge183(iscapture)
}

fun SDL_GetAudioDeviceName(index: Int, iscapture: Int): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge184(index, iscapture))
}
...
fun SDL_OpenAudioDevice(@CCall.CString device: String?, iscapture: Int, desired: CValuesRef<SDL_AudioSpec>?, obtained: CValuesRef<SDL_AudioSpec>?, allowed_changes: Int): SDL_AudioDeviceID {
    memScoped {
        return kniBridge185(device?.cstr?.getPointer(memScope).rawValue, iscapture, desired?.getPointer(memScope).rawValue, obtained?.getPointer(memScope).rawValue, allowed_changes)
    }
}
...
fun SDL_LoadWAV_RW(src: CValuesRef<SDL_RWops>?, freesrc: Int, spec: CValuesRef<SDL_AudioSpec>?, audio_buf: CValuesRef<CPointerVar<Uint8Var>>?, audio_len: CValuesRef<Uint32Var>?): CPointer<SDL_AudioSpec>? {
    memScoped {
        return interpretCPointer<SDL_AudioSpec>(kniBridge190(src?.getPointer(memScope).rawValue, freesrc, spec?.getPointer(memScope).rawValue, audio_buf?.getPointer(memScope).rawValue, audio_len?.getPointer(memScope).rawValue))
    }
}

fun SDL_FreeWAV(audio_buf: CValuesRef<Uint8Var>?): Unit {
    memScoped {
        return kniBridge191(audio_buf?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_BuildAudioCVT(cvt: CValuesRef<SDL_AudioCVT>?, src_format: SDL_AudioFormat, src_channels: Uint8, src_rate: Int, dst_format: SDL_AudioFormat, dst_channels: Uint8, dst_rate: Int): Int {
    memScoped {
        return kniBridge192(cvt?.getPointer(memScope).rawValue, src_format, src_channels, src_rate, dst_format, dst_channels, dst_rate)
    }
}

fun SDL_ConvertAudio(cvt: CValuesRef<SDL_AudioCVT>?): Int {
    memScoped {
        return kniBridge193(cvt?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_NewAudioStream(src_format: SDL_AudioFormat, src_channels: Uint8, src_rate: Int, dst_format: SDL_AudioFormat, dst_channels: Uint8, dst_rate: Int): CPointer<SDL_AudioStream>? {
    return interpretCPointer<SDL_AudioStream>(kniBridge194(src_format, src_channels, src_rate, dst_format, dst_channels, dst_rate))
}

fun SDL_AudioStreamPut(stream: CValuesRef<SDL_AudioStream>?, buf: CValuesRef<*>?, len: Int): Int {
    memScoped {
        return kniBridge195(stream?.getPointer(memScope).rawValue, buf?.getPointer(memScope).rawValue, len)
    }
}

fun SDL_AudioStreamGet(stream: CValuesRef<SDL_AudioStream>?, buf: CValuesRef<*>?, len: Int): Int {
    memScoped {
        return kniBridge196(stream?.getPointer(memScope).rawValue, buf?.getPointer(memScope).rawValue, len)
    }
}

fun SDL_AudioStreamAvailable(stream: CValuesRef<SDL_AudioStream>?): Int {
    memScoped {
        return kniBridge197(stream?.getPointer(memScope).rawValue)
    }
}

fun SDL_AudioStreamFlush(stream: CValuesRef<SDL_AudioStream>?): Int {
    memScoped {
        return kniBridge198(stream?.getPointer(memScope).rawValue)
    }
}

fun SDL_AudioStreamClear(stream: CValuesRef<SDL_AudioStream>?): Unit {
    memScoped {
        return kniBridge199(stream?.getPointer(memScope).rawValue)
    }
}

fun SDL_FreeAudioStream(stream: CValuesRef<SDL_AudioStream>?): Unit {
    memScoped {
        return kniBridge200(stream?.getPointer(memScope).rawValue)
    }
}

fun SDL_MixAudio(dst: CValuesRef<Uint8Var>?, src: CValuesRef<Uint8Var>?, len: Uint32, volume: Int): Unit {
    memScoped {
        return kniBridge201(dst?.getPointer(memScope).rawValue, src?.getPointer(memScope).rawValue, len, volume)
    }
}

fun SDL_MixAudioFormat(dst: CValuesRef<Uint8Var>?, src: CValuesRef<Uint8Var>?, format: SDL_AudioFormat, len: Uint32, volume: Int): Unit {
    memScoped {
        return kniBridge202(dst?.getPointer(memScope).rawValue, src?.getPointer(memScope).rawValue, format, len, volume)
    }
}

fun SDL_QueueAudio(dev: SDL_AudioDeviceID, data: CValuesRef<*>?, len: Uint32): Int {
    memScoped {
        return kniBridge203(dev, data?.getPointer(memScope).rawValue, len)
    }
}

fun SDL_DequeueAudio(dev: SDL_AudioDeviceID, data: CValuesRef<*>?, len: Uint32): Uint32 {
    memScoped {
        return kniBridge204(dev, data?.getPointer(memScope).rawValue, len)
    }
}

fun SDL_GetQueuedAudioSize(dev: SDL_AudioDeviceID): Uint32 {
    return kniBridge205(dev)
}

fun SDL_ClearQueuedAudio(dev: SDL_AudioDeviceID): Unit {
    return kniBridge206(dev)
}
...
fun SDL_CloseAudioDevice(dev: SDL_AudioDeviceID): Unit {
    return kniBridge212(dev)
}

fun SDL_SetClipboardText(@CCall.CString text: String?): Int {
    memScoped {
        return kniBridge213(text?.cstr?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetClipboardText(): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge214())
}
...
fun SDL_GetPixelFormatName(format: Uint32): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge232(format))
}
...
fun SDL_PixelFormatEnumToMasks(format: Uint32, bpp: CValuesRef<IntVar>?, Rmask: CValuesRef<Uint32Var>?, Gmask: CValuesRef<Uint32Var>?, Bmask: CValuesRef<Uint32Var>?, Amask: CValuesRef<Uint32Var>?): SDL_bool {
    memScoped {
        return kniBridge233(format, bpp?.getPointer(memScope).rawValue, Rmask?.getPointer(memScope).rawValue, Gmask?.getPointer(memScope).rawValue, Bmask?.getPointer(memScope).rawValue, Amask?.getPointer(memScope).rawValue)
    }
}

fun SDL_MasksToPixelFormatEnum(bpp: Int, Rmask: Uint32, Gmask: Uint32, Bmask: Uint32, Amask: Uint32): Uint32 {
    return kniBridge234(bpp, Rmask, Gmask, Bmask, Amask)
}

fun SDL_AllocFormat(pixel_format: Uint32): CPointer<SDL_PixelFormat>? {
    return interpretCPointer<SDL_PixelFormat>(kniBridge235(pixel_format))
}

fun SDL_FreeFormat(format: CValuesRef<SDL_PixelFormat>?): Unit {
    memScoped {
        return kniBridge236(format?.getPointer(memScope).rawValue)
    }
}

fun SDL_AllocPalette(ncolors: Int): CPointer<SDL_Palette>? {
    return interpretCPointer<SDL_Palette>(kniBridge237(ncolors))
}

fun SDL_SetPixelFormatPalette(format: CValuesRef<SDL_PixelFormat>?, palette: CValuesRef<SDL_Palette>?): Int {
    memScoped {
        return kniBridge238(format?.getPointer(memScope).rawValue, palette?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetPaletteColors(palette: CValuesRef<SDL_Palette>?, colors: CValuesRef<SDL_Color>?, firstcolor: Int, ncolors: Int): Int {
    memScoped {
        return kniBridge239(palette?.getPointer(memScope).rawValue, colors?.getPointer(memScope).rawValue, firstcolor, ncolors)
    }
}

fun SDL_FreePalette(palette: CValuesRef<SDL_Palette>?): Unit {
    memScoped {
        return kniBridge240(palette?.getPointer(memScope).rawValue)
    }
}

fun SDL_MapRGB(format: CValuesRef<SDL_PixelFormat>?, r: Uint8, g: Uint8, b: Uint8): Uint32 {
    memScoped {
        return kniBridge241(format?.getPointer(memScope).rawValue, r, g, b)
    }
}

fun SDL_MapRGBA(format: CValuesRef<SDL_PixelFormat>?, r: Uint8, g: Uint8, b: Uint8, a: Uint8): Uint32 {
    memScoped {
        return kniBridge242(format?.getPointer(memScope).rawValue, r, g, b, a)
    }
}
...
fun SDL_GetRGB(pixel: Uint32, format: CValuesRef<SDL_PixelFormat>?, r: CValuesRef<Uint8Var>?, g: CValuesRef<Uint8Var>?, b: CValuesRef<Uint8Var>?): Unit {
    memScoped {
        return kniBridge243(pixel, format?.getPointer(memScope).rawValue, r?.getPointer(memScope).rawValue, g?.getPointer(memScope).rawValue, b?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GetRGBA(pixel: Uint32, format: CValuesRef<SDL_PixelFormat>?, r: CValuesRef<Uint8Var>?, g: CValuesRef<Uint8Var>?, b: CValuesRef<Uint8Var>?, a: CValuesRef<Uint8Var>?): Unit {
    memScoped {
        return kniBridge244(pixel, format?.getPointer(memScope).rawValue, r?.getPointer(memScope).rawValue, g?.getPointer(memScope).rawValue, b?.getPointer(memScope).rawValue, a?.getPointer(memScope).rawValue)
    }
}

fun SDL_CalculateGammaRamp(gamma: Float, ramp: CValuesRef<Uint16Var>?): Unit {
    memScoped {
        return kniBridge245(gamma, ramp?.getPointer(memScope).rawValue)
    }
}

fun SDL_PointInRect(p: CValuesRef<SDL_Point>?, r: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge246(p?.getPointer(memScope).rawValue, r?.getPointer(memScope).rawValue)
    }
}

fun SDL_RectEmpty(r: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge247(r?.getPointer(memScope).rawValue)
    }
}

fun SDL_RectEquals(a: CValuesRef<SDL_Rect>?, b: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge248(a?.getPointer(memScope).rawValue, b?.getPointer(memScope).rawValue)
    }
}

fun SDL_HasIntersection(A: CValuesRef<SDL_Rect>?, B: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge249(A?.getPointer(memScope).rawValue, B?.getPointer(memScope).rawValue)
    }
}

fun SDL_IntersectRect(A: CValuesRef<SDL_Rect>?, B: CValuesRef<SDL_Rect>?, result: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge250(A?.getPointer(memScope).rawValue, B?.getPointer(memScope).rawValue, result?.getPointer(memScope).rawValue)
    }
}

fun SDL_UnionRect(A: CValuesRef<SDL_Rect>?, B: CValuesRef<SDL_Rect>?, result: CValuesRef<SDL_Rect>?): Unit {
    memScoped {
        return kniBridge251(A?.getPointer(memScope).rawValue, B?.getPointer(memScope).rawValue, result?.getPointer(memScope).rawValue)
    }
}

fun SDL_EnclosePoints(points: CValuesRef<SDL_Point>?, count: Int, clip: CValuesRef<SDL_Rect>?, result: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge252(points?.getPointer(memScope).rawValue, count, clip?.getPointer(memScope).rawValue, result?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_IntersectRectAndLine(rect: CValuesRef<SDL_Rect>?, X1: CValuesRef<IntVar>?, Y1: CValuesRef<IntVar>?, X2: CValuesRef<IntVar>?, Y2: CValuesRef<IntVar>?): SDL_bool {
    memScoped {
        return kniBridge253(rect?.getPointer(memScope).rawValue, X1?.getPointer(memScope).rawValue, Y1?.getPointer(memScope).rawValue, X2?.getPointer(memScope).rawValue, Y2?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_ComposeCustomBlendMode(srcColorFactor: SDL_BlendFactor, dstColorFactor: SDL_BlendFactor, colorOperation: SDL_BlendOperation, srcAlphaFactor: SDL_BlendFactor, dstAlphaFactor: SDL_BlendFactor, alphaOperation: SDL_BlendOperation): SDL_BlendMode {
    return kniBridge254(srcColorFactor, dstColorFactor, colorOperation, srcAlphaFactor, dstAlphaFactor, alphaOperation)
}
...
fun SDL_CreateRGBSurface(flags: Uint32, width: Int, height: Int, depth: Int, Rmask: Uint32, Gmask: Uint32, Bmask: Uint32, Amask: Uint32): CPointer<SDL_Surface>? {
    return interpretCPointer<SDL_Surface>(kniBridge255(flags, width, height, depth, Rmask, Gmask, Bmask, Amask))
}

fun SDL_CreateRGBSurfaceWithFormat(flags: Uint32, width: Int, height: Int, depth: Int, format: Uint32): CPointer<SDL_Surface>? {
    return interpretCPointer<SDL_Surface>(kniBridge256(flags, width, height, depth, format))
}
...
fun SDL_CreateRGBSurfaceFrom(pixels: CValuesRef<*>?, width: Int, height: Int, depth: Int, pitch: Int, Rmask: Uint32, Gmask: Uint32, Bmask: Uint32, Amask: Uint32): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge257(pixels?.getPointer(memScope).rawValue, width, height, depth, pitch, Rmask, Gmask, Bmask, Amask))
    }
}
...
fun SDL_CreateRGBSurfaceWithFormatFrom(pixels: CValuesRef<*>?, width: Int, height: Int, depth: Int, pitch: Int, format: Uint32): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge258(pixels?.getPointer(memScope).rawValue, width, height, depth, pitch, format))
    }
}

fun SDL_FreeSurface(surface: CValuesRef<SDL_Surface>?): Unit {
    memScoped {
        return kniBridge259(surface?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetSurfacePalette(surface: CValuesRef<SDL_Surface>?, palette: CValuesRef<SDL_Palette>?): Int {
    memScoped {
        return kniBridge260(surface?.getPointer(memScope).rawValue, palette?.getPointer(memScope).rawValue)
    }
}

fun SDL_LockSurface(surface: CValuesRef<SDL_Surface>?): Int {
    memScoped {
        return kniBridge261(surface?.getPointer(memScope).rawValue)
    }
}

fun SDL_UnlockSurface(surface: CValuesRef<SDL_Surface>?): Unit {
    memScoped {
        return kniBridge262(surface?.getPointer(memScope).rawValue)
    }
}

fun SDL_LoadBMP_RW(src: CValuesRef<SDL_RWops>?, freesrc: Int): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge263(src?.getPointer(memScope).rawValue, freesrc))
    }
}

fun SDL_SaveBMP_RW(surface: CValuesRef<SDL_Surface>?, dst: CValuesRef<SDL_RWops>?, freedst: Int): Int {
    memScoped {
        return kniBridge264(surface?.getPointer(memScope).rawValue, dst?.getPointer(memScope).rawValue, freedst)
    }
}

fun SDL_SetSurfaceRLE(surface: CValuesRef<SDL_Surface>?, flag: Int): Int {
    memScoped {
        return kniBridge265(surface?.getPointer(memScope).rawValue, flag)
    }
}

fun SDL_SetColorKey(surface: CValuesRef<SDL_Surface>?, flag: Int, key: Uint32): Int {
    memScoped {
        return kniBridge266(surface?.getPointer(memScope).rawValue, flag, key)
    }
}
...
fun SDL_GetColorKey(surface: CValuesRef<SDL_Surface>?, key: CValuesRef<Uint32Var>?): Int {
    memScoped {
        return kniBridge268(surface?.getPointer(memScope).rawValue, key?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetSurfaceColorMod(surface: CValuesRef<SDL_Surface>?, r: Uint8, g: Uint8, b: Uint8): Int {
    memScoped {
        return kniBridge269(surface?.getPointer(memScope).rawValue, r, g, b)
    }
}
...
fun SDL_GetSurfaceColorMod(surface: CValuesRef<SDL_Surface>?, r: CValuesRef<Uint8Var>?, g: CValuesRef<Uint8Var>?, b: CValuesRef<Uint8Var>?): Int {
    memScoped {
        return kniBridge270(surface?.getPointer(memScope).rawValue, r?.getPointer(memScope).rawValue, g?.getPointer(memScope).rawValue, b?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetSurfaceAlphaMod(surface: CValuesRef<SDL_Surface>?, alpha: Uint8): Int {
    memScoped {
        return kniBridge271(surface?.getPointer(memScope).rawValue, alpha)
    }
}

fun SDL_GetSurfaceAlphaMod(surface: CValuesRef<SDL_Surface>?, alpha: CValuesRef<Uint8Var>?): Int {
    memScoped {
        return kniBridge272(surface?.getPointer(memScope).rawValue, alpha?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetSurfaceBlendMode(surface: CValuesRef<SDL_Surface>?, blendMode: SDL_BlendMode): Int {
    memScoped {
        return kniBridge273(surface?.getPointer(memScope).rawValue, blendMode)
    }
}

fun SDL_GetSurfaceBlendMode(surface: CValuesRef<SDL_Surface>?, blendMode: CValuesRef<SDL_BlendModeVar>?): Int {
    memScoped {
        return kniBridge274(surface?.getPointer(memScope).rawValue, blendMode?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetClipRect(surface: CValuesRef<SDL_Surface>?, rect: CValuesRef<SDL_Rect>?): SDL_bool {
    memScoped {
        return kniBridge275(surface?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetClipRect(surface: CValuesRef<SDL_Surface>?, rect: CValuesRef<SDL_Rect>?): Unit {
    memScoped {
        return kniBridge276(surface?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_DuplicateSurface(surface: CValuesRef<SDL_Surface>?): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge277(surface?.getPointer(memScope).rawValue))
    }
}

fun SDL_ConvertSurface(src: CValuesRef<SDL_Surface>?, fmt: CValuesRef<SDL_PixelFormat>?, flags: Uint32): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge278(src?.getPointer(memScope).rawValue, fmt?.getPointer(memScope).rawValue, flags))
    }
}

fun SDL_ConvertSurfaceFormat(src: CValuesRef<SDL_Surface>?, pixel_format: Uint32, flags: Uint32): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge279(src?.getPointer(memScope).rawValue, pixel_format, flags))
    }
}
...
fun SDL_ConvertPixels(width: Int, height: Int, src_format: Uint32, src: CValuesRef<*>?, src_pitch: Int, dst_format: Uint32, dst: CValuesRef<*>?, dst_pitch: Int): Int {
    memScoped {
        return kniBridge280(width, height, src_format, src?.getPointer(memScope).rawValue, src_pitch, dst_format, dst?.getPointer(memScope).rawValue, dst_pitch)
    }
}

fun SDL_FillRect(dst: CValuesRef<SDL_Surface>?, rect: CValuesRef<SDL_Rect>?, color: Uint32): Int {
    memScoped {
        return kniBridge281(dst?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue, color)
    }
}

fun SDL_FillRects(dst: CValuesRef<SDL_Surface>?, rects: CValuesRef<SDL_Rect>?, count: Int, color: Uint32): Int {
    memScoped {
        return kniBridge282(dst?.getPointer(memScope).rawValue, rects?.getPointer(memScope).rawValue, count, color)
    }
}
...
fun SDL_UpperBlit(src: CValuesRef<SDL_Surface>?, srcrect: CValuesRef<SDL_Rect>?, dst: CValuesRef<SDL_Surface>?, dstrect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge283(src?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dst?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_LowerBlit(src: CValuesRef<SDL_Surface>?, srcrect: CValuesRef<SDL_Rect>?, dst: CValuesRef<SDL_Surface>?, dstrect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge284(src?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dst?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_SoftStretch(src: CValuesRef<SDL_Surface>?, srcrect: CValuesRef<SDL_Rect>?, dst: CValuesRef<SDL_Surface>?, dstrect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge285(src?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dst?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_UpperBlitScaled(src: CValuesRef<SDL_Surface>?, srcrect: CValuesRef<SDL_Rect>?, dst: CValuesRef<SDL_Surface>?, dstrect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge286(src?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dst?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_LowerBlitScaled(src: CValuesRef<SDL_Surface>?, srcrect: CValuesRef<SDL_Rect>?, dst: CValuesRef<SDL_Surface>?, dstrect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge287(src?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dst?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetYUVConversionMode(mode: SDL_YUV_CONVERSION_MODE): Unit {
    return kniBridge288(mode.value)
}

fun SDL_GetYUVConversionMode(): SDL_YUV_CONVERSION_MODE {
    return SDL_YUV_CONVERSION_MODE.byValue(kniBridge289())
}

fun SDL_GetYUVConversionModeForResolution(width: Int, height: Int): SDL_YUV_CONVERSION_MODE {
    return SDL_YUV_CONVERSION_MODE.byValue(kniBridge290(width, height))
}
...
fun SDL_GetVideoDriver(index: Int): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge292(index))
}

fun SDL_VideoInit(@CCall.CString driver_name: String?): Int {
    memScoped {
        return kniBridge293(driver_name?.cstr?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GetCurrentVideoDriver(): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge295())
}
...
fun SDL_GetClosestDisplayMode(displayIndex: Int, mode: CValuesRef<SDL_DisplayMode>?, closest: CValuesRef<SDL_DisplayMode>?): CPointer<SDL_DisplayMode>? {
    memScoped {
        return interpretCPointer<SDL_DisplayMode>(kniBridge306(displayIndex, mode?.getPointer(memScope).rawValue, closest?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetWindowDisplayIndex(window: CValuesRef<SDL_Window>?): Int {
    memScoped {
        return kniBridge307(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowDisplayMode(window: CValuesRef<SDL_Window>?, mode: CValuesRef<SDL_DisplayMode>?): Int {
    memScoped {
        return kniBridge308(window?.getPointer(memScope).rawValue, mode?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetWindowDisplayMode(window: CValuesRef<SDL_Window>?, mode: CValuesRef<SDL_DisplayMode>?): Int {
    memScoped {
        return kniBridge309(window?.getPointer(memScope).rawValue, mode?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetWindowPixelFormat(window: CValuesRef<SDL_Window>?): Uint32 {
    memScoped {
        return kniBridge310(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_CreateWindow(@CCall.CString title: String?, x: Int, y: Int, w: Int, h: Int, flags: Uint32): CPointer<SDL_Window>? {
    memScoped {
        return interpretCPointer<SDL_Window>(kniBridge311(title?.cstr?.getPointer(memScope).rawValue, x, y, w, h, flags))
    }
}

fun SDL_CreateWindowFrom(data: CValuesRef<*>?): CPointer<SDL_Window>? {
    memScoped {
        return interpretCPointer<SDL_Window>(kniBridge312(data?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetWindowID(window: CValuesRef<SDL_Window>?): Uint32 {
    memScoped {
        return kniBridge313(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetWindowFromID(id: Uint32): CPointer<SDL_Window>? {
    return interpretCPointer<SDL_Window>(kniBridge314(id))
}
...
fun SDL_SetWindowTitle(window: CValuesRef<SDL_Window>?, @CCall.CString title: String?): Unit {
    memScoped {
        return kniBridge316(window?.getPointer(memScope).rawValue, title?.cstr?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetWindowTitle(window: CValuesRef<SDL_Window>?): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge317(window?.getPointer(memScope).rawValue))
    }
}

fun SDL_SetWindowIcon(window: CValuesRef<SDL_Window>?, icon: CValuesRef<SDL_Surface>?): Unit {
    memScoped {
        return kniBridge318(window?.getPointer(memScope).rawValue, icon?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowData(window: CValuesRef<SDL_Window>?, @CCall.CString name: String?, userdata: CValuesRef<*>?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge319(window?.getPointer(memScope).rawValue, name?.cstr?.getPointer(memScope).rawValue, userdata?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetWindowData(window: CValuesRef<SDL_Window>?, @CCall.CString name: String?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge320(window?.getPointer(memScope).rawValue, name?.cstr?.getPointer(memScope).rawValue))
    }
}

fun SDL_SetWindowPosition(window: CValuesRef<SDL_Window>?, x: Int, y: Int): Unit {
    memScoped {
        return kniBridge321(window?.getPointer(memScope).rawValue, x, y)
    }
}

fun SDL_GetWindowPosition(window: CValuesRef<SDL_Window>?, x: CValuesRef<IntVar>?, y: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge322(window?.getPointer(memScope).rawValue, x?.getPointer(memScope).rawValue, y?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowSize(window: CValuesRef<SDL_Window>?, w: Int, h: Int): Unit {
    memScoped {
        return kniBridge323(window?.getPointer(memScope).rawValue, w, h)
    }
}

fun SDL_GetWindowSize(window: CValuesRef<SDL_Window>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge324(window?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GetWindowBordersSize(window: CValuesRef<SDL_Window>?, top: CValuesRef<IntVar>?, left: CValuesRef<IntVar>?, bottom: CValuesRef<IntVar>?, right: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge325(window?.getPointer(memScope).rawValue, top?.getPointer(memScope).rawValue, left?.getPointer(memScope).rawValue, bottom?.getPointer(memScope).rawValue, right?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowMinimumSize(window: CValuesRef<SDL_Window>?, min_w: Int, min_h: Int): Unit {
    memScoped {
        return kniBridge326(window?.getPointer(memScope).rawValue, min_w, min_h)
    }
}

fun SDL_GetWindowMinimumSize(window: CValuesRef<SDL_Window>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge327(window?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowMaximumSize(window: CValuesRef<SDL_Window>?, max_w: Int, max_h: Int): Unit {
    memScoped {
        return kniBridge328(window?.getPointer(memScope).rawValue, max_w, max_h)
    }
}

fun SDL_GetWindowMaximumSize(window: CValuesRef<SDL_Window>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge329(window?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowBordered(window: CValuesRef<SDL_Window>?, bordered: SDL_bool): Unit {
    memScoped {
        return kniBridge330(window?.getPointer(memScope).rawValue, bordered)
    }
}

fun SDL_SetWindowResizable(window: CValuesRef<SDL_Window>?, resizable: SDL_bool): Unit {
    memScoped {
        return kniBridge331(window?.getPointer(memScope).rawValue, resizable)
    }
}

fun SDL_ShowWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge332(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_HideWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge333(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_RaiseWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge334(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_MaximizeWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge335(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_MinimizeWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge336(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_RestoreWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge337(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowFullscreen(window: CValuesRef<SDL_Window>?, flags: Uint32): Int {
    memScoped {
        return kniBridge338(window?.getPointer(memScope).rawValue, flags)
    }
}

fun SDL_GetWindowSurface(window: CValuesRef<SDL_Window>?): CPointer<SDL_Surface>? {
    memScoped {
        return interpretCPointer<SDL_Surface>(kniBridge339(window?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_UpdateWindowSurfaceRects(window: CValuesRef<SDL_Window>?, rects: CValuesRef<SDL_Rect>?, numrects: Int): Int {
    memScoped {
        return kniBridge341(window?.getPointer(memScope).rawValue, rects?.getPointer(memScope).rawValue, numrects)
    }
}

fun SDL_SetWindowGrab(window: CValuesRef<SDL_Window>?, grabbed: SDL_bool): Unit {
    memScoped {
        return kniBridge342(window?.getPointer(memScope).rawValue, grabbed)
    }
}
...
fun SDL_GetGrabbedWindow(): CPointer<SDL_Window>? {
    return interpretCPointer<SDL_Window>(kniBridge344())
}

fun SDL_SetWindowBrightness(window: CValuesRef<SDL_Window>?, brightness: Float): Int {
    memScoped {
        return kniBridge345(window?.getPointer(memScope).rawValue, brightness)
    }
}

fun SDL_GetWindowBrightness(window: CValuesRef<SDL_Window>?): Float {
    memScoped {
        return kniBridge346(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowOpacity(window: CValuesRef<SDL_Window>?, opacity: Float): Int {
    memScoped {
        return kniBridge347(window?.getPointer(memScope).rawValue, opacity)
    }
}

fun SDL_GetWindowOpacity(window: CValuesRef<SDL_Window>?, out_opacity: CValuesRef<FloatVar>?): Int {
    memScoped {
        return kniBridge348(window?.getPointer(memScope).rawValue, out_opacity?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowModalFor(modal_window: CValuesRef<SDL_Window>?, parent_window: CValuesRef<SDL_Window>?): Int {
    memScoped {
        return kniBridge349(modal_window?.getPointer(memScope).rawValue, parent_window?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowInputFocus(window: CValuesRef<SDL_Window>?): Int {
    memScoped {
        return kniBridge350(window?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_SetWindowGammaRamp(window: CValuesRef<SDL_Window>?, red: CValuesRef<Uint16Var>?, green: CValuesRef<Uint16Var>?, blue: CValuesRef<Uint16Var>?): Int {
    memScoped {
        return kniBridge351(window?.getPointer(memScope).rawValue, red?.getPointer(memScope).rawValue, green?.getPointer(memScope).rawValue, blue?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GetWindowGammaRamp(window: CValuesRef<SDL_Window>?, red: CValuesRef<Uint16Var>?, green: CValuesRef<Uint16Var>?, blue: CValuesRef<Uint16Var>?): Int {
    memScoped {
        return kniBridge352(window?.getPointer(memScope).rawValue, red?.getPointer(memScope).rawValue, green?.getPointer(memScope).rawValue, blue?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowHitTest(window: CValuesRef<SDL_Window>?, callback: SDL_HitTest?, callback_data: CValuesRef<*>?): Int {
    memScoped {
        return kniBridge353(window?.getPointer(memScope).rawValue, callback.rawValue, callback_data?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GL_LoadLibrary(@CCall.CString path: String?): Int {
    memScoped {
        return kniBridge358(path?.cstr?.getPointer(memScope).rawValue)
    }
}

fun SDL_GL_GetProcAddress(@CCall.CString proc: String?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge359(proc?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_GL_ExtensionSupported(@CCall.CString extension: String?): SDL_bool {
    memScoped {
        return kniBridge361(extension?.cstr?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GL_SetAttribute(attr: SDL_GLattr, value: Int): Int {
    return kniBridge363(attr.value, value)
}

fun SDL_GL_GetAttribute(attr: SDL_GLattr, value: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge364(attr.value, value?.getPointer(memScope).rawValue)
    }
}

fun SDL_GL_CreateContext(window: CValuesRef<SDL_Window>?): SDL_GLContext? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge365(window?.getPointer(memScope).rawValue))
    }
}

fun SDL_GL_MakeCurrent(window: CValuesRef<SDL_Window>?, context: SDL_GLContext?): Int {
    memScoped {
        return kniBridge366(window?.getPointer(memScope).rawValue, context.rawValue)
    }
}

fun SDL_GL_GetCurrentWindow(): CPointer<SDL_Window>? {
    return interpretCPointer<SDL_Window>(kniBridge367())
}

fun SDL_GL_GetCurrentContext(): SDL_GLContext? {
    return interpretCPointer<COpaque>(kniBridge368())
}

fun SDL_GL_GetDrawableSize(window: CValuesRef<SDL_Window>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge369(window?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}

fun SDL_GL_SetSwapInterval(interval: Int): Int {
    return kniBridge370(interval)
}
...
fun SDL_GL_SwapWindow(window: CValuesRef<SDL_Window>?): Unit {
    memScoped {
        return kniBridge372(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_GL_DeleteContext(context: SDL_GLContext?): Unit {
    return kniBridge373(context.rawValue)
}

fun SDL_GetKeyboardFocus(): CPointer<SDL_Window>? {
    return interpretCPointer<SDL_Window>(kniBridge374())
}

fun SDL_GetKeyboardState(numkeys: CValuesRef<IntVar>?): CPointer<Uint8Var>? {
    memScoped {
        return interpretCPointer<Uint8Var>(kniBridge375(numkeys?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_SetTextInputRect(rect: CValuesRef<SDL_Rect>?): Unit {
    memScoped {
        return kniBridge387(rect?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_IsScreenKeyboardShown(window: CValuesRef<SDL_Window>?): SDL_bool {
    memScoped {
        return kniBridge389(window?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetMouseFocus(): CPointer<SDL_Window>? {
    return interpretCPointer<SDL_Window>(kniBridge390())
}

fun SDL_GetMouseState(x: CValuesRef<IntVar>?, y: CValuesRef<IntVar>?): Uint32 {
    memScoped {
        return kniBridge391(x?.getPointer(memScope).rawValue, y?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetGlobalMouseState(x: CValuesRef<IntVar>?, y: CValuesRef<IntVar>?): Uint32 {
    memScoped {
        return kniBridge392(x?.getPointer(memScope).rawValue, y?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetRelativeMouseState(x: CValuesRef<IntVar>?, y: CValuesRef<IntVar>?): Uint32 {
    memScoped {
        return kniBridge393(x?.getPointer(memScope).rawValue, y?.getPointer(memScope).rawValue)
    }
}

fun SDL_WarpMouseInWindow(window: CValuesRef<SDL_Window>?, x: Int, y: Int): Unit {
    memScoped {
        return kniBridge394(window?.getPointer(memScope).rawValue, x, y)
    }
}

fun SDL_WarpMouseGlobal(x: Int, y: Int): Int {
    return kniBridge395(x, y)
}

fun SDL_SetRelativeMouseMode(enabled: SDL_bool): Int {
    return kniBridge396(enabled)
}

fun SDL_CaptureMouse(enabled: SDL_bool): Int {
    return kniBridge397(enabled)
}
...
fun SDL_CreateCursor(data: CValuesRef<Uint8Var>?, mask: CValuesRef<Uint8Var>?, w: Int, h: Int, hot_x: Int, hot_y: Int): CPointer<SDL_Cursor>? {
    memScoped {
        return interpretCPointer<SDL_Cursor>(kniBridge399(data?.getPointer(memScope).rawValue, mask?.getPointer(memScope).rawValue, w, h, hot_x, hot_y))
    }
}

fun SDL_CreateColorCursor(surface: CValuesRef<SDL_Surface>?, hot_x: Int, hot_y: Int): CPointer<SDL_Cursor>? {
    memScoped {
        return interpretCPointer<SDL_Cursor>(kniBridge400(surface?.getPointer(memScope).rawValue, hot_x, hot_y))
    }
}

fun SDL_CreateSystemCursor(id: SDL_SystemCursor): CPointer<SDL_Cursor>? {
    return interpretCPointer<SDL_Cursor>(kniBridge401(id.value))
}

fun SDL_SetCursor(cursor: CValuesRef<SDL_Cursor>?): Unit {
    memScoped {
        return kniBridge402(cursor?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetCursor(): CPointer<SDL_Cursor>? {
    return interpretCPointer<SDL_Cursor>(kniBridge403())
}

fun SDL_GetDefaultCursor(): CPointer<SDL_Cursor>? {
    return interpretCPointer<SDL_Cursor>(kniBridge404())
}

fun SDL_FreeCursor(cursor: CValuesRef<SDL_Cursor>?): Unit {
    memScoped {
        return kniBridge405(cursor?.getPointer(memScope).rawValue)
    }
}

fun SDL_ShowCursor(toggle: Int): Int {
    return kniBridge406(toggle)
}
...
fun SDL_JoystickGetGUID(joystick: CValuesRef<SDL_Joystick>?): CValue<SDL_JoystickGUID> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<SDL_JoystickGUID>()
        try {
            kniBridge422(joystick?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun SDL_JoystickGetVendor(joystick: CValuesRef<SDL_Joystick>?): Uint16 {
    memScoped {
        return kniBridge423(joystick?.getPointer(memScope).rawValue)
    }
}

fun SDL_JoystickGetProduct(joystick: CValuesRef<SDL_Joystick>?): Uint16 {
    memScoped {
        return kniBridge424(joystick?.getPointer(memScope).rawValue)
    }
}

fun SDL_JoystickGetProductVersion(joystick: CValuesRef<SDL_Joystick>?): Uint16 {
    memScoped {
        return kniBridge425(joystick?.getPointer(memScope).rawValue)
    }
}

fun SDL_JoystickGetType(joystick: CValuesRef<SDL_Joystick>?): SDL_JoystickType {
    memScoped {
        return SDL_JoystickType.byValue(kniBridge426(joystick?.getPointer(memScope).rawValue))
    }
}

fun SDL_JoystickGetGUIDString(guid: CValue<SDL_JoystickGUID>, pszGUID: CValuesRef<ByteVar>?, cbGUID: Int): Unit {
    memScoped {
        return kniBridge427(guid.getPointer(memScope).rawValue, pszGUID?.getPointer(memScope).rawValue, cbGUID)
    }
}
...
fun SDL_JoystickGetGUIDFromString(@CCall.CString pchGUID: String?): CValue<SDL_JoystickGUID> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<SDL_JoystickGUID>()
        try {
            kniBridge428(pchGUID?.cstr?.getPointer(memScope).rawValue, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun SDL_JoystickInstanceID(joystick: CValuesRef<SDL_Joystick>?): SDL_JoystickID {
    memScoped {
        return kniBridge430(joystick?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_JoystickNumButtons(joystick: CValuesRef<SDL_Joystick>?): Int {
    memScoped {
        return kniBridge434(joystick?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_JoystickRumble(joystick: CValuesRef<SDL_Joystick>?, low_frequency_rumble: Uint16, high_frequency_rumble: Uint16, duration_ms: Uint32): Int {
    memScoped {
        return kniBridge442(joystick?.getPointer(memScope).rawValue, low_frequency_rumble, high_frequency_rumble, duration_ms)
    }
}

fun SDL_JoystickClose(joystick: CValuesRef<SDL_Joystick>?): Unit {
    memScoped {
        return kniBridge443(joystick?.getPointer(memScope).rawValue)
    }
}

fun SDL_JoystickCurrentPowerLevel(joystick: CValuesRef<SDL_Joystick>?): SDL_JoystickPowerLevel {
    memScoped {
        return kniBridge444(joystick?.getPointer(memScope).rawValue)
    }
}

fun SDL_GameControllerAddMappingsFromRW(rw: CValuesRef<SDL_RWops>?, freerw: Int): Int {
    memScoped {
        return kniBridge445(rw?.getPointer(memScope).rawValue, freerw)
    }
}

fun SDL_GameControllerAddMapping(@CCall.CString mappingString: String?): Int {
    memScoped {
        return kniBridge446(mappingString?.cstr?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_GameControllerGetAxisFromString(@CCall.CString pchString: String?): SDL_GameControllerAxis {
    memScoped {
        return kniBridge465(pchString?.cstr?.getPointer(memScope).rawValue)
    }
}

fun SDL_GameControllerGetStringForAxis(axis: SDL_GameControllerAxis): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge466(axis))
}
...
fun SDL_GameControllerGetBindForAxis(gamecontroller: CValuesRef<SDL_GameController>?, axis: SDL_GameControllerAxis): CValue<SDL_GameControllerButtonBind> {
    memScoped {
        ...
        try {
            kniBridge467(gamecontroller?.getPointer(memScope).rawValue, axis, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun SDL_GameControllerGetBindForButton(gamecontroller: CValuesRef<SDL_GameController>?, button: SDL_GameControllerButton): CValue<SDL_GameControllerButtonBind> {
    memScoped {
        val kniRetVal = nativeHeap.alloc<SDL_GameControllerButtonBind>()
        try {
            kniBridge471(gamecontroller?.getPointer(memScope).rawValue, button, kniRetVal.rawPtr)
            return kniRetVal.readValue()
        } finally { nativeHeap.free(kniRetVal) }
    }
}
...
fun SDL_GameControllerGetButton(gamecontroller: CValuesRef<SDL_GameController>?, button: SDL_GameControllerButton): Uint8 {
    memScoped {
        return kniBridge472(gamecontroller?.getPointer(memScope).rawValue, button)
    }
}
...
fun SDL_GameControllerRumble(gamecontroller: CValuesRef<SDL_GameController>?, low_frequency_rumble: Uint16, high_frequency_rumble: Uint16, duration_ms: Uint32): Int {
    memScoped {
        return kniBridge473(gamecontroller?.getPointer(memScope).rawValue, low_frequency_rumble, high_frequency_rumble, duration_ms)
    }
}

fun SDL_GameControllerClose(gamecontroller: CValuesRef<SDL_GameController>?): Unit {
    memScoped {
        return kniBridge474(gamecontroller?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_PeepEvents(events: CValuesRef<SDL_Event>?, numevents: Int, action: SDL_eventaction, minType: Uint32, maxType: Uint32): Int {
    memScoped {
        return kniBridge484(events?.getPointer(memScope).rawValue, numevents, action.value, minType, maxType)
    }
}

fun SDL_HasEvent(type: Uint32): SDL_bool {
    return kniBridge485(type)
}

fun SDL_HasEvents(minType: Uint32, maxType: Uint32): SDL_bool {
    return kniBridge486(minType, maxType)
}

fun SDL_FlushEvent(type: Uint32): Unit {
    return kniBridge487(type)
}

fun SDL_FlushEvents(minType: Uint32, maxType: Uint32): Unit {
    return kniBridge488(minType, maxType)
}

fun SDL_PollEvent(event: CValuesRef<SDL_Event>?): Int {
    memScoped {
        return kniBridge489(event?.getPointer(memScope).rawValue)
    }
}

fun SDL_WaitEvent(event: CValuesRef<SDL_Event>?): Int {
    memScoped {
        return kniBridge490(event?.getPointer(memScope).rawValue)
    }
}

fun SDL_WaitEventTimeout(event: CValuesRef<SDL_Event>?, timeout: Int): Int {
    memScoped {
        return kniBridge491(event?.getPointer(memScope).rawValue, timeout)
    }
}

fun SDL_PushEvent(event: CValuesRef<SDL_Event>?): Int {
    memScoped {
        return kniBridge492(event?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetEventFilter(filter: SDL_EventFilter?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge493(filter.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetEventFilter(filter: CValuesRef<SDL_EventFilterVar>?, userdata: CValuesRef<COpaquePointerVar>?): SDL_bool {
    memScoped {
        return kniBridge494(filter?.getPointer(memScope).rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_AddEventWatch(filter: SDL_EventFilter?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge495(filter.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_DelEventWatch(filter: SDL_EventFilter?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge496(filter.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_FilterEvents(filter: SDL_EventFilter?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge497(filter.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_EventState(type: Uint32, state: Int): Uint8 {
    return kniBridge498(type, state)
}

fun SDL_RegisterEvents(numevents: Int): Uint32 {
    return kniBridge499(numevents)
}

fun SDL_GetBasePath(): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge500())
}

fun SDL_GetPrefPath(@CCall.CString org: String?, @CCall.CString app: String?): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge501(org?.cstr?.getPointer(memScope).rawValue, app?.cstr?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_HapticName(device_index: Int): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge503(device_index))
}

fun SDL_HapticOpen(device_index: Int): CPointer<SDL_Haptic>? {
    return interpretCPointer<SDL_Haptic>(kniBridge504(device_index))
}

fun SDL_HapticOpened(device_index: Int): Int {
    return kniBridge505(device_index)
}

fun SDL_HapticIndex(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge506(haptic?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_HapticOpenFromMouse(): CPointer<SDL_Haptic>? {
    return interpretCPointer<SDL_Haptic>(kniBridge508())
}

fun SDL_JoystickIsHaptic(joystick: CValuesRef<SDL_Joystick>?): Int {
    memScoped {
        return kniBridge509(joystick?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticOpenFromJoystick(joystick: CValuesRef<SDL_Joystick>?): CPointer<SDL_Haptic>? {
    memScoped {
        return interpretCPointer<SDL_Haptic>(kniBridge510(joystick?.getPointer(memScope).rawValue))
    }
}

fun SDL_HapticClose(haptic: CValuesRef<SDL_Haptic>?): Unit {
    memScoped {
        return kniBridge511(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticNumEffects(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge512(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticNumEffectsPlaying(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge513(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticQuery(haptic: CValuesRef<SDL_Haptic>?): UInt {
    memScoped {
        return kniBridge514(haptic?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_HapticEffectSupported(haptic: CValuesRef<SDL_Haptic>?, effect: CValuesRef<SDL_HapticEffect>?): Int {
    memScoped {
        return kniBridge516(haptic?.getPointer(memScope).rawValue, effect?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticNewEffect(haptic: CValuesRef<SDL_Haptic>?, effect: CValuesRef<SDL_HapticEffect>?): Int {
    memScoped {
        return kniBridge517(haptic?.getPointer(memScope).rawValue, effect?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticUpdateEffect(haptic: CValuesRef<SDL_Haptic>?, effect: Int, data: CValuesRef<SDL_HapticEffect>?): Int {
    memScoped {
        return kniBridge518(haptic?.getPointer(memScope).rawValue, effect, data?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticRunEffect(haptic: CValuesRef<SDL_Haptic>?, effect: Int, iterations: Uint32): Int {
    memScoped {
        return kniBridge519(haptic?.getPointer(memScope).rawValue, effect, iterations)
    }
}

fun SDL_HapticStopEffect(haptic: CValuesRef<SDL_Haptic>?, effect: Int): Int {
    memScoped {
        return kniBridge520(haptic?.getPointer(memScope).rawValue, effect)
    }
}

fun SDL_HapticDestroyEffect(haptic: CValuesRef<SDL_Haptic>?, effect: Int): Unit {
    memScoped {
        return kniBridge521(haptic?.getPointer(memScope).rawValue, effect)
    }
}

fun SDL_HapticGetEffectStatus(haptic: CValuesRef<SDL_Haptic>?, effect: Int): Int {
    memScoped {
        return kniBridge522(haptic?.getPointer(memScope).rawValue, effect)
    }
}

fun SDL_HapticSetGain(haptic: CValuesRef<SDL_Haptic>?, gain: Int): Int {
    memScoped {
        return kniBridge523(haptic?.getPointer(memScope).rawValue, gain)
    }
}

fun SDL_HapticSetAutocenter(haptic: CValuesRef<SDL_Haptic>?, autocenter: Int): Int {
    memScoped {
        return kniBridge524(haptic?.getPointer(memScope).rawValue, autocenter)
    }
}

fun SDL_HapticPause(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge525(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticUnpause(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge526(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticStopAll(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge527(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticRumbleSupported(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge528(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticRumbleInit(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge529(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_HapticRumblePlay(haptic: CValuesRef<SDL_Haptic>?, strength: Float, length: Uint32): Int {
    memScoped {
        return kniBridge530(haptic?.getPointer(memScope).rawValue, strength, length)
    }
}

fun SDL_HapticRumbleStop(haptic: CValuesRef<SDL_Haptic>?): Int {
    memScoped {
        return kniBridge531(haptic?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetHintWithPriority(@CCall.CString name: String?, @CCall.CString value: String?, priority: SDL_HintPriority): SDL_bool {
    memScoped {
        return kniBridge532(name?.cstr?.getPointer(memScope).rawValue, value?.cstr?.getPointer(memScope).rawValue, priority.value)
    }
}

fun SDL_SetHint(@CCall.CString name: String?, @CCall.CString value: String?): SDL_bool {
    memScoped {
        return kniBridge533(name?.cstr?.getPointer(memScope).rawValue, value?.cstr?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetHint(@CCall.CString name: String?): CPointer<ByteVar>? {
    memScoped {
        return interpretCPointer<ByteVar>(kniBridge534(name?.cstr?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetHintBoolean(@CCall.CString name: String?, default_value: SDL_bool): SDL_bool {
    memScoped {
        return kniBridge535(name?.cstr?.getPointer(memScope).rawValue, default_value)
    }
}

fun SDL_AddHintCallback(@CCall.CString name: String?, callback: SDL_HintCallback?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge536(name?.cstr?.getPointer(memScope).rawValue, callback.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_DelHintCallback(@CCall.CString name: String?, callback: SDL_HintCallback?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge537(name?.cstr?.getPointer(memScope).rawValue, callback.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_LoadObject(@CCall.CString sofile: String?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge539(sofile?.cstr?.getPointer(memScope).rawValue))
    }
}

fun SDL_LoadFunction(handle: CValuesRef<*>?, @CCall.CString name: String?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge540(handle?.getPointer(memScope).rawValue, name?.cstr?.getPointer(memScope).rawValue))
    }
}

fun SDL_UnloadObject(handle: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge541(handle?.getPointer(memScope).rawValue)
    }
}

fun SDL_LogSetAllPriority(priority: SDL_LogPriority): Unit {
    return kniBridge542(priority)
}

fun SDL_LogSetPriority(category: Int, priority: SDL_LogPriority): Unit {
    return kniBridge543(category, priority)
}

fun SDL_LogGetPriority(category: Int): SDL_LogPriority {
    return kniBridge544(category)
}
...
fun SDL_LogMessageV(category: Int, priority: SDL_LogPriority, @CCall.CString fmt: String?, ap: va_list?): Unit {
    memScoped {
        return kniBridge546(category, priority, fmt?.cstr?.getPointer(memScope).rawValue, ap.rawValue)
    }
}

fun SDL_LogGetOutputFunction(callback: CValuesRef<SDL_LogOutputFunctionVar>?, userdata: CValuesRef<COpaquePointerVar>?): Unit {
    memScoped {
        return kniBridge547(callback?.getPointer(memScope).rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_LogSetOutputFunction(callback: SDL_LogOutputFunction?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge548(callback.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_ShowMessageBox(messageboxdata: CValuesRef<SDL_MessageBoxData>?, buttonid: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge549(messageboxdata?.getPointer(memScope).rawValue, buttonid?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_ShowSimpleMessageBox(flags: Uint32, @CCall.CString title: String?, @CCall.CString message: String?, window: CValuesRef<SDL_Window>?): Int {
    memScoped {
        return kniBridge550(flags, title?.cstr?.getPointer(memScope).rawValue, message?.cstr?.getPointer(memScope).rawValue, window?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetPowerInfo(secs: CValuesRef<IntVar>?, pct: CValuesRef<IntVar>?): SDL_PowerState {
    memScoped {
        return SDL_PowerState.byValue(kniBridge551(secs?.getPointer(memScope).rawValue, pct?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_GetRenderDriverInfo(index: Int, info: CValuesRef<SDL_RendererInfo>?): Int {
    memScoped {
        return kniBridge553(index, info?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_CreateWindowAndRenderer(width: Int, height: Int, window_flags: Uint32, window: CValuesRef<CPointerVar<SDL_Window>>?, renderer: CValuesRef<CPointerVar<SDL_Renderer>>?): Int {
    memScoped {
        return kniBridge554(width, height, window_flags, window?.getPointer(memScope).rawValue, renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_CreateRenderer(window: CValuesRef<SDL_Window>?, index: Int, flags: Uint32): CPointer<SDL_Renderer>? {
    memScoped {
        return interpretCPointer<SDL_Renderer>(kniBridge555(window?.getPointer(memScope).rawValue, index, flags))
    }
}

fun SDL_CreateSoftwareRenderer(surface: CValuesRef<SDL_Surface>?): CPointer<SDL_Renderer>? {
    memScoped {
        return interpretCPointer<SDL_Renderer>(kniBridge556(surface?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetRenderer(window: CValuesRef<SDL_Window>?): CPointer<SDL_Renderer>? {
    memScoped {
        return interpretCPointer<SDL_Renderer>(kniBridge557(window?.getPointer(memScope).rawValue))
    }
}

fun SDL_GetRendererInfo(renderer: CValuesRef<SDL_Renderer>?, info: CValuesRef<SDL_RendererInfo>?): Int {
    memScoped {
        return kniBridge558(renderer?.getPointer(memScope).rawValue, info?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetRendererOutputSize(renderer: CValuesRef<SDL_Renderer>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge559(renderer?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}

fun SDL_CreateTexture(renderer: CValuesRef<SDL_Renderer>?, format: Uint32, access: Int, w: Int, h: Int): CPointer<SDL_Texture>? {
    memScoped {
        return interpretCPointer<SDL_Texture>(kniBridge560(renderer?.getPointer(memScope).rawValue, format, access, w, h))
    }
}

fun SDL_CreateTextureFromSurface(renderer: CValuesRef<SDL_Renderer>?, surface: CValuesRef<SDL_Surface>?): CPointer<SDL_Texture>? {
    memScoped {
        return interpretCPointer<SDL_Texture>(kniBridge561(renderer?.getPointer(memScope).rawValue, surface?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_QueryTexture(texture: CValuesRef<SDL_Texture>?, format: CValuesRef<Uint32Var>?, access: CValuesRef<IntVar>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge562(texture?.getPointer(memScope).rawValue, format?.getPointer(memScope).rawValue, access?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetTextureColorMod(texture: CValuesRef<SDL_Texture>?, r: Uint8, g: Uint8, b: Uint8): Int {
    memScoped {
        return kniBridge563(texture?.getPointer(memScope).rawValue, r, g, b)
    }
}
...
fun SDL_GetTextureColorMod(texture: CValuesRef<SDL_Texture>?, r: CValuesRef<Uint8Var>?, g: CValuesRef<Uint8Var>?, b: CValuesRef<Uint8Var>?): Int {
    memScoped {
        return kniBridge564(texture?.getPointer(memScope).rawValue, r?.getPointer(memScope).rawValue, g?.getPointer(memScope).rawValue, b?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetTextureAlphaMod(texture: CValuesRef<SDL_Texture>?, alpha: Uint8): Int {
    memScoped {
        return kniBridge565(texture?.getPointer(memScope).rawValue, alpha)
    }
}

fun SDL_GetTextureAlphaMod(texture: CValuesRef<SDL_Texture>?, alpha: CValuesRef<Uint8Var>?): Int {
    memScoped {
        return kniBridge566(texture?.getPointer(memScope).rawValue, alpha?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetTextureBlendMode(texture: CValuesRef<SDL_Texture>?, blendMode: SDL_BlendMode): Int {
    memScoped {
        return kniBridge567(texture?.getPointer(memScope).rawValue, blendMode)
    }
}

fun SDL_GetTextureBlendMode(texture: CValuesRef<SDL_Texture>?, blendMode: CValuesRef<SDL_BlendModeVar>?): Int {
    memScoped {
        return kniBridge568(texture?.getPointer(memScope).rawValue, blendMode?.getPointer(memScope).rawValue)
    }
}

fun SDL_UpdateTexture(texture: CValuesRef<SDL_Texture>?, rect: CValuesRef<SDL_Rect>?, pixels: CValuesRef<*>?, pitch: Int): Int {
    memScoped {
        return kniBridge569(texture?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue, pixels?.getPointer(memScope).rawValue, pitch)
    }
}
...
fun SDL_UpdateYUVTexture(texture: CValuesRef<SDL_Texture>?, rect: CValuesRef<SDL_Rect>?, Yplane: CValuesRef<Uint8Var>?, Ypitch: Int, Uplane: CValuesRef<Uint8Var>?, Upitch: Int, Vplane: CValuesRef<Uint8Var>?, Vpitch: Int): Int {
    memScoped {
        return kniBridge570(texture?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue, Yplane?.getPointer(memScope).rawValue, Ypitch, Uplane?.getPointer(memScope).rawValue, Upitch, Vplane?.getPointer(memScope).rawValue, Vpitch)
    }
}
...
fun SDL_LockTexture(texture: CValuesRef<SDL_Texture>?, rect: CValuesRef<SDL_Rect>?, pixels: CValuesRef<COpaquePointerVar>?, pitch: CValuesRef<IntVar>?): Int {
    memScoped {
        return kniBridge571(texture?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue, pixels?.getPointer(memScope).rawValue, pitch?.getPointer(memScope).rawValue)
    }
}

fun SDL_UnlockTexture(texture: CValuesRef<SDL_Texture>?): Unit {
    memScoped {
        return kniBridge572(texture?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderTargetSupported(renderer: CValuesRef<SDL_Renderer>?): SDL_bool {
    memScoped {
        return kniBridge573(renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetRenderTarget(renderer: CValuesRef<SDL_Renderer>?, texture: CValuesRef<SDL_Texture>?): Int {
    memScoped {
        return kniBridge574(renderer?.getPointer(memScope).rawValue, texture?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetRenderTarget(renderer: CValuesRef<SDL_Renderer>?): CPointer<SDL_Texture>? {
    memScoped {
        return interpretCPointer<SDL_Texture>(kniBridge575(renderer?.getPointer(memScope).rawValue))
    }
}

fun SDL_RenderSetLogicalSize(renderer: CValuesRef<SDL_Renderer>?, w: Int, h: Int): Int {
    memScoped {
        return kniBridge576(renderer?.getPointer(memScope).rawValue, w, h)
    }
}

fun SDL_RenderGetLogicalSize(renderer: CValuesRef<SDL_Renderer>?, w: CValuesRef<IntVar>?, h: CValuesRef<IntVar>?): Unit {
    memScoped {
        return kniBridge577(renderer?.getPointer(memScope).rawValue, w?.getPointer(memScope).rawValue, h?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderSetIntegerScale(renderer: CValuesRef<SDL_Renderer>?, enable: SDL_bool): Int {
    memScoped {
        return kniBridge578(renderer?.getPointer(memScope).rawValue, enable)
    }
}

fun SDL_RenderGetIntegerScale(renderer: CValuesRef<SDL_Renderer>?): SDL_bool {
    memScoped {
        return kniBridge579(renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderSetViewport(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge580(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderGetViewport(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?): Unit {
    memScoped {
        return kniBridge581(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderSetClipRect(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge582(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderGetClipRect(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?): Unit {
    memScoped {
        return kniBridge583(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderIsClipEnabled(renderer: CValuesRef<SDL_Renderer>?): SDL_bool {
    memScoped {
        return kniBridge584(renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderSetScale(renderer: CValuesRef<SDL_Renderer>?, scaleX: Float, scaleY: Float): Int {
    memScoped {
        return kniBridge585(renderer?.getPointer(memScope).rawValue, scaleX, scaleY)
    }
}

fun SDL_RenderGetScale(renderer: CValuesRef<SDL_Renderer>?, scaleX: CValuesRef<FloatVar>?, scaleY: CValuesRef<FloatVar>?): Unit {
    memScoped {
        return kniBridge586(renderer?.getPointer(memScope).rawValue, scaleX?.getPointer(memScope).rawValue, scaleY?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetRenderDrawColor(renderer: CValuesRef<SDL_Renderer>?, r: Uint8, g: Uint8, b: Uint8, a: Uint8): Int {
    memScoped {
        return kniBridge587(renderer?.getPointer(memScope).rawValue, r, g, b, a)
    }
}
...
fun SDL_GetRenderDrawColor(renderer: CValuesRef<SDL_Renderer>?, r: CValuesRef<Uint8Var>?, g: CValuesRef<Uint8Var>?, b: CValuesRef<Uint8Var>?, a: CValuesRef<Uint8Var>?): Int {
    memScoped {
        return kniBridge588(renderer?.getPointer(memScope).rawValue, r?.getPointer(memScope).rawValue, g?.getPointer(memScope).rawValue, b?.getPointer(memScope).rawValue, a?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetRenderDrawBlendMode(renderer: CValuesRef<SDL_Renderer>?, blendMode: SDL_BlendMode): Int {
    memScoped {
        return kniBridge589(renderer?.getPointer(memScope).rawValue, blendMode)
    }
}

fun SDL_GetRenderDrawBlendMode(renderer: CValuesRef<SDL_Renderer>?, blendMode: CValuesRef<SDL_BlendModeVar>?): Int {
    memScoped {
        return kniBridge590(renderer?.getPointer(memScope).rawValue, blendMode?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderClear(renderer: CValuesRef<SDL_Renderer>?): Int {
    memScoped {
        return kniBridge591(renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderDrawPoint(renderer: CValuesRef<SDL_Renderer>?, x: Int, y: Int): Int {
    memScoped {
        return kniBridge592(renderer?.getPointer(memScope).rawValue, x, y)
    }
}

fun SDL_RenderDrawPoints(renderer: CValuesRef<SDL_Renderer>?, points: CValuesRef<SDL_Point>?, count: Int): Int {
    memScoped {
        return kniBridge593(renderer?.getPointer(memScope).rawValue, points?.getPointer(memScope).rawValue, count)
    }
}

fun SDL_RenderDrawLine(renderer: CValuesRef<SDL_Renderer>?, x1: Int, y1: Int, x2: Int, y2: Int): Int {
    memScoped {
        return kniBridge594(renderer?.getPointer(memScope).rawValue, x1, y1, x2, y2)
    }
}

fun SDL_RenderDrawLines(renderer: CValuesRef<SDL_Renderer>?, points: CValuesRef<SDL_Point>?, count: Int): Int {
    memScoped {
        return kniBridge595(renderer?.getPointer(memScope).rawValue, points?.getPointer(memScope).rawValue, count)
    }
}

fun SDL_RenderDrawRect(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge596(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderDrawRects(renderer: CValuesRef<SDL_Renderer>?, rects: CValuesRef<SDL_Rect>?, count: Int): Int {
    memScoped {
        return kniBridge597(renderer?.getPointer(memScope).rawValue, rects?.getPointer(memScope).rawValue, count)
    }
}

fun SDL_RenderFillRect(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge598(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderFillRects(renderer: CValuesRef<SDL_Renderer>?, rects: CValuesRef<SDL_Rect>?, count: Int): Int {
    memScoped {
        return kniBridge599(renderer?.getPointer(memScope).rawValue, rects?.getPointer(memScope).rawValue, count)
    }
}
...
fun SDL_RenderCopy(renderer: CValuesRef<SDL_Renderer>?, texture: CValuesRef<SDL_Texture>?, srcrect: CValuesRef<SDL_Rect>?, dstrect: CValuesRef<SDL_Rect>?): Int {
    memScoped {
        return kniBridge600(renderer?.getPointer(memScope).rawValue, texture?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_RenderCopyEx(renderer: CValuesRef<SDL_Renderer>?, texture: CValuesRef<SDL_Texture>?, srcrect: CValuesRef<SDL_Rect>?, dstrect: CValuesRef<SDL_Rect>?, angle: Double, center: CValuesRef<SDL_Point>?, flip: SDL_RendererFlip): Int {
    memScoped {
        return kniBridge601(renderer?.getPointer(memScope).rawValue, texture?.getPointer(memScope).rawValue, srcrect?.getPointer(memScope).rawValue, dstrect?.getPointer(memScope).rawValue, angle, center?.getPointer(memScope).rawValue, flip)
    }
}
...
fun SDL_RenderReadPixels(renderer: CValuesRef<SDL_Renderer>?, rect: CValuesRef<SDL_Rect>?, format: Uint32, pixels: CValuesRef<*>?, pitch: Int): Int {
    memScoped {
        return kniBridge602(renderer?.getPointer(memScope).rawValue, rect?.getPointer(memScope).rawValue, format, pixels?.getPointer(memScope).rawValue, pitch)
    }
}

fun SDL_RenderPresent(renderer: CValuesRef<SDL_Renderer>?): Unit {
    memScoped {
        return kniBridge603(renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_DestroyTexture(texture: CValuesRef<SDL_Texture>?): Unit {
    memScoped {
        return kniBridge604(texture?.getPointer(memScope).rawValue)
    }
}

fun SDL_DestroyRenderer(renderer: CValuesRef<SDL_Renderer>?): Unit {
    memScoped {
        return kniBridge605(renderer?.getPointer(memScope).rawValue)
    }
}

fun SDL_GL_BindTexture(texture: CValuesRef<SDL_Texture>?, texw: CValuesRef<FloatVar>?, texh: CValuesRef<FloatVar>?): Int {
    memScoped {
        return kniBridge606(texture?.getPointer(memScope).rawValue, texw?.getPointer(memScope).rawValue, texh?.getPointer(memScope).rawValue)
    }
}

fun SDL_GL_UnbindTexture(texture: CValuesRef<SDL_Texture>?): Int {
    memScoped {
        return kniBridge607(texture?.getPointer(memScope).rawValue)
    }
}

fun SDL_RenderGetMetalLayer(renderer: CValuesRef<SDL_Renderer>?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge608(renderer?.getPointer(memScope).rawValue))
    }
}

fun SDL_RenderGetMetalCommandEncoder(renderer: CValuesRef<SDL_Renderer>?): COpaquePointer? {
    memScoped {
        return interpretCPointer<COpaque>(kniBridge609(renderer?.getPointer(memScope).rawValue))
    }
}
...
fun SDL_CreateShapedWindow(@CCall.CString title: String?, x: UInt, y: UInt, w: UInt, h: UInt, flags: Uint32): CPointer<SDL_Window>? {
    memScoped {
        return interpretCPointer<SDL_Window>(kniBridge624(title?.cstr?.getPointer(memScope).rawValue, x, y, w, h, flags))
    }
}

fun SDL_IsShapedWindow(window: CValuesRef<SDL_Window>?): SDL_bool {
    memScoped {
        return kniBridge625(window?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_SetWindowShape(window: CValuesRef<SDL_Window>?, shape: CValuesRef<SDL_Surface>?, shape_mode: CValuesRef<SDL_WindowShapeMode>?): Int {
    memScoped {
        return kniBridge626(window?.getPointer(memScope).rawValue, shape?.getPointer(memScope).rawValue, shape_mode?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetShapedWindowMode(window: CValuesRef<SDL_Window>?, shape_mode: CValuesRef<SDL_WindowShapeMode>?): Int {
    memScoped {
        return kniBridge627(window?.getPointer(memScope).rawValue, shape_mode?.getPointer(memScope).rawValue)
    }
}

fun SDL_SetWindowsMessageHook(callback: SDL_WindowsMessageHook?, userdata: CValuesRef<*>?): Unit {
    memScoped {
        return kniBridge628(callback.rawValue, userdata?.getPointer(memScope).rawValue)
    }
}

fun SDL_Direct3D9GetAdapterIndex(displayIndex: Int): Int {
    return kniBridge629(displayIndex)
}

fun SDL_RenderGetD3D9Device(renderer: CValuesRef<SDL_Renderer>?): CPointer<IDirect3DDevice9>? {
    memScoped {
        return interpretCPointer<IDirect3DDevice9>(kniBridge630(renderer?.getPointer(memScope).rawValue))
    }
}

fun SDL_DXGIGetOutputInfo(displayIndex: Int, adapterIndex: CValuesRef<IntVar>?, outputIndex: CValuesRef<IntVar>?): SDL_bool {
    memScoped {
        return kniBridge631(displayIndex, adapterIndex?.getPointer(memScope).rawValue, outputIndex?.getPointer(memScope).rawValue)
    }
}
...
fun SDL_Delay(ms: Uint32): Unit {
    return kniBridge636(ms)
}

fun SDL_AddTimer(interval: Uint32, callback: SDL_TimerCallback?, param: CValuesRef<*>?): SDL_TimerID {
    memScoped {
        return kniBridge637(interval, callback.rawValue, param?.getPointer(memScope).rawValue)
    }
}

fun SDL_RemoveTimer(id: SDL_TimerID): SDL_bool {
    return kniBridge638(id)
}

fun SDL_GetVersion(ver: CValuesRef<SDL_version>?): Unit {
    memScoped {
        return kniBridge639(ver?.getPointer(memScope).rawValue)
    }
}

fun SDL_GetRevision(): CPointer<ByteVar>? {
    return interpretCPointer<ByteVar>(kniBridge640())
}
...
const val HAVE_WINAPIFAMILY_H: Int = 0

const val WINAPI_FAMILY_WINRT: Int = 0

const val __WINDOWS__: Int = 1

const val __WIN32__: Int = 1

const val HAVE_STDINT_H: Int = 1

const val SIZEOF_VOIDP: Int = 8

const val HAVE_DDRAW_H: Int = 1

const val HAVE_DINPUT_H: Int = 1

const val HAVE_DSOUND_H: Int = 1

const val HAVE_DXGI_H: Int = 1

const val HAVE_XINPUT_H: Int = 1

const val HAVE_MMDEVICEAPI_H: Int = 1

const val HAVE_AUDIOCLIENT_H: Int = 1

const val HAVE_ENDPOINTVOLUME_H: Int = 1

const val HAVE_STDARG_H: Int = 1

const val HAVE_STDDEF_H: Int = 1

const val SDL_AUDIO_DRIVER_WASAPI: Int = 1

const val SDL_AUDIO_DRIVER_DSOUND: Int = 1

const val SDL_AUDIO_DRIVER_WINMM: Int = 1

const val SDL_AUDIO_DRIVER_DISK: Int = 1

const val SDL_AUDIO_DRIVER_DUMMY: Int = 1

const val SDL_JOYSTICK_DINPUT: Int = 1

const val SDL_JOYSTICK_XINPUT: Int = 1

const val SDL_JOYSTICK_HIDAPI: Int = 1

const val SDL_HAPTIC_DINPUT: Int = 1

const val SDL_HAPTIC_XINPUT: Int = 1

const val SDL_SENSOR_DUMMY: Int = 1

const val SDL_LOADSO_WINDOWS: Int = 1

const val SDL_THREAD_WINDOWS: Int = 1

const val SDL_TIMER_WINDOWS: Int = 1

const val SDL_VIDEO_DRIVER_DUMMY: Int = 1

const val SDL_VIDEO_DRIVER_WINDOWS: Int = 1

const val SDL_VIDEO_RENDER_D3D: Int = 1

const val SDL_VIDEO_RENDER_D3D11: Int = 0

const val SDL_VIDEO_OPENGL: Int = 1

const val SDL_VIDEO_OPENGL_WGL: Int = 1
...
const val SDL_POWER_WINDOWS: Int = 1

const val SDL_FILESYSTEM_WINDOWS: Int = 1
...
val SDL_PRIs64: String get() = "I64d"

val SDL_PRIu64: String get() = "I64u"

val SDL_PRIx64: String get() = "I64x"
...
val SDL_FILE: String get() = "C:\u005CUsers\u005CSTRATU\u007E1\u005CAppData\u005CLocal\u005CTemp\u005Ctmp9531038883953382020.c"

const val SDL_LINE: Int = 1
...
val SDL_HINT_ANDROID_SEPARATE_MOUSE_AND_TOUCH: String get() = "SDL_ANDROID_SEPARATE_MOUSE_AND_TOUCH"
...
const val SDL_PATCHLEVEL: Int = 9

const val SDL_COMPILEDVERSION: Int = 2009
...
val main: CPointer<CFunction<(Int, CArrayPointer<CPointerVar<ByteVar>>?) -> Int>>?
    get() = interpretCPointer<CFunction<(Int, CArrayPointer<CPointerVar<ByteVar>>?) -> Int>>(kniBridge647())

val SDL_FUNCTION: CPointer<ByteVar>?
    get() = interpretCPointer<ByteVar>(kniBridge648())

val SDL_BlitSurface: CPointer<CFunction<(CPointer<SDL_Surface>?, CPointer<SDL_Rect>?, CPointer<SDL_Surface>?, CPointer<SDL_Rect>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<SDL_Surface>?, CPointer<SDL_Rect>?, CPointer<SDL_Surface>?, CPointer<SDL_Rect>?) -> Int>>(kniBridge649())

val SDL_BlitScaled: CPointer<CFunction<(CPointer<SDL_Surface>?, CPointer<SDL_Rect>?, CPointer<SDL_Surface>?, CPointer<SDL_Rect>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<SDL_Surface>?, CPointer<SDL_Rect>?, CPointer<SDL_Surface>?, CPointer<SDL_Rect>?) -> Int>>(kniBridge650())
...
@CStruct("struct { void* p0; void* p1; void* p2; void* p3; void* p4; unsigned int p5; union { struct { unsigned int p0; void* p1; struct { void* p0; unsigned long long p1; unsigned long long p2; } p2; } p0; struct { void* p0; void* p1; void* p2; } p1; struct { void* p0; void* p1; } p2; } p6; }")
...
@CStruct("union { struct { unsigned int p0; void* p1; struct { void* p0; unsigned long long p1; unsigned long long p2; } p2; } p0; struct { void* p0; void* p1; void* p2; } p1; struct { void* p0; void* p1; } p2; }")
class anonymousStruct1(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    val mem: anonymousStruct4
        get() = memberAt(0)
    
    val unknown: anonymousStruct5
        get() = memberAt(0)
    
}

@CStruct("struct { unsigned int p0; void* p1; struct { void* p0; unsigned long long p1; unsigned long long p2; } p2; }")
class anonymousStruct2(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    val buffer: anonymousStruct3
        get() = memberAt(16)
    
}

@CStruct("struct { void* p0; unsigned long long p1; unsigned long long p2; }")
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_pixels.h:51:1):
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_pixels.h:68:1):
val SDL_BITMAPORDER_NONE: UInt get() = 0u
val SDL_BITMAPORDER_4321: UInt get() = 1u
val SDL_BITMAPORDER_1234: UInt get() = 2u

// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_pixels.h:76:1):
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_pixels.h:92:1):
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_pixels.h:104:1):
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_pixels.h:171:1):
val SDL_PIXELFORMAT_UNKNOWN: UInt get() = 0u
val SDL_PIXELFORMAT_INDEX1LSB: UInt get() = 286261504u
val SDL_PIXELFORMAT_INDEX1MSB: UInt get() = 287310080u
val SDL_PIXELFORMAT_INDEX4LSB: UInt get() = 303039488u
val SDL_PIXELFORMAT_INDEX4MSB: UInt get() = 304088064u
val SDL_PIXELFORMAT_INDEX8: UInt get() = 318769153u
val SDL_PIXELFORMAT_RGB332: UInt get() = 336660481u
val SDL_PIXELFORMAT_RGB444: UInt get() = 353504258u
val SDL_PIXELFORMAT_RGB555: UInt get() = 353570562u
val SDL_PIXELFORMAT_BGR555: UInt get() = 357764866u
val SDL_PIXELFORMAT_ARGB4444: UInt get() = 355602434u
val SDL_PIXELFORMAT_RGBA4444: UInt get() = 356651010u
val SDL_PIXELFORMAT_ABGR4444: UInt get() = 359796738u
val SDL_PIXELFORMAT_BGRA4444: UInt get() = 360845314u
val SDL_PIXELFORMAT_ARGB1555: UInt get() = 355667970u
val SDL_PIXELFORMAT_RGBA5551: UInt get() = 356782082u
val SDL_PIXELFORMAT_ABGR1555: UInt get() = 359862274u
val SDL_PIXELFORMAT_BGRA5551: UInt get() = 360976386u
val SDL_PIXELFORMAT_RGB565: UInt get() = 353701890u
val SDL_PIXELFORMAT_BGR565: UInt get() = 357896194u
val SDL_PIXELFORMAT_RGB24: UInt get() = 386930691u
val SDL_PIXELFORMAT_BGR24: UInt get() = 390076419u
val SDL_PIXELFORMAT_RGB888: UInt get() = 370546692u
val SDL_PIXELFORMAT_RGBX8888: UInt get() = 371595268u
val SDL_PIXELFORMAT_BGR888: UInt get() = 374740996u
val SDL_PIXELFORMAT_BGRX8888: UInt get() = 375789572u
val SDL_PIXELFORMAT_ARGB8888: UInt get() = 372645892u
val SDL_PIXELFORMAT_RGBA8888: UInt get() = 373694468u
val SDL_PIXELFORMAT_ABGR8888: UInt get() = 376840196u
val SDL_PIXELFORMAT_BGRA8888: UInt get() = 377888772u
val SDL_PIXELFORMAT_ARGB2101010: UInt get() = 372711428u
val SDL_PIXELFORMAT_RGBA32: UInt get() = 376840196u
val SDL_PIXELFORMAT_ARGB32: UInt get() = 377888772u
val SDL_PIXELFORMAT_BGRA32: UInt get() = 372645892u
val SDL_PIXELFORMAT_ABGR32: UInt get() = 373694468u
val SDL_PIXELFORMAT_YV12: UInt get() = 842094169u
val SDL_PIXELFORMAT_IYUV: UInt get() = 1448433993u
val SDL_PIXELFORMAT_YUY2: UInt get() = 844715353u
val SDL_PIXELFORMAT_UYVY: UInt get() = 1498831189u
val SDL_PIXELFORMAT_YVYU: UInt get() = 1431918169u
val SDL_PIXELFORMAT_NV12: UInt get() = 842094158u
val SDL_PIXELFORMAT_NV21: UInt get() = 825382478u
val SDL_PIXELFORMAT_EXTERNAL_OES: UInt get() = 542328143u
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_keycode.h:50:1):
...
// enum (anonymous at C:\Users\Stratulat Stefanel\.konan\dependencies\msys2-mingw-w64-x86_64-gcc-7.3.0-clang-llvm-lld-6.0.1\include\SDL_log.h:64:1):
...
typealias SDL_threadIDVar = UIntVarOf<SDL_threadID>
typealias SDL_threadID = UInt
...
typealias pfnSDL_CurrentBeginThread = CPointer<CFunction<(COpaquePointer?, UInt, CPointer<CFunction<(COpaquePointer?) -> UInt>>?, COpaquePointer?, UInt, CPointer<UIntVar>?) -> uintptr_t>>

typealias pfnSDL_CurrentEndThreadVar = CPointerVarOf<pfnSDL_CurrentEndThread>
typealias pfnSDL_CurrentEndThread = CPointer<CFunction<(UInt) -> Unit>>
...
typealias SDL_WindowsMessageHook = CPointer<CFunction<(COpaquePointer?, COpaquePointer?, UInt, Uint64, Sint64) -> Unit>>
...
private external fun kniBridge40(p0: Int, p1: NativePtr, p2: Int): NativePtr
@SymbolName("sdl_kniBridge41")
private external fun kniBridge41(p0: UInt, p1: NativePtr, p2: Int): NativePtr
...
private external fun kniBridge46(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge47")
private external fun kniBridge47(p0: NativePtr, p1: NativePtr, p2: Int): UInt
...
private external fun kniBridge100(p0: NativePtr, p1: UInt, p2: NativePtr): Int
@SymbolName("sdl_kniBridge101")
private external fun kniBridge101(): Unit
@SymbolName("sdl_kniBridge102")
private external fun kniBridge102(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int): UInt
...
private external fun kniBridge107(): Unit
@SymbolName("sdl_kniBridge108")
private external fun kniBridge108(p0: NativePtr): UInt
...
private external fun kniBridge112(): Unit
@SymbolName("sdl_kniBridge113")
private external fun kniBridge113(p0: NativePtr, p1: Int, p2: Int): UInt
...
private external fun kniBridge116(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge117")
private external fun kniBridge117(p0: NativePtr, p1: NativePtr, p2: NativePtr): UInt
...
private external fun kniBridge121(): Unit
@SymbolName("sdl_kniBridge122")
private external fun kniBridge122(p0: UInt): Int
@SymbolName("sdl_kniBridge123")
private external fun kniBridge123(p0: UShort): UShort
@SymbolName("sdl_kniBridge124")
private external fun kniBridge124(p0: UInt): UInt
@SymbolName("sdl_kniBridge125")
private external fun kniBridge125(p0: ULong): ULong
@SymbolName("sdl_kniBridge126")
private external fun kniBridge126(p0: Float): Float
...
private external fun kniBridge132(p0: UInt): NativePtr
...
private external fun kniBridge136(p0: NativePtr, p1: UInt): Int
@SymbolName("sdl_kniBridge137")
private external fun kniBridge137(p0: NativePtr): Int
@SymbolName("sdl_kniBridge138")
private external fun kniBridge138(p0: NativePtr): UInt
...
private external fun kniBridge143(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge144")
private external fun kniBridge144(p0: NativePtr, p1: NativePtr, p2: UInt): Int
...
private external fun kniBridge149(p0: NativePtr): UInt
...
private external fun kniBridge153(): UInt
@SymbolName("sdl_kniBridge154")
private external fun kniBridge154(p0: UInt): NativePtr
@SymbolName("sdl_kniBridge155")
private external fun kniBridge155(p0: UInt, p1: NativePtr, p2: NativePtr): Int
...
private external fun kniBridge157(p0: NativePtr, p1: UInt): NativePtr
@SymbolName("sdl_kniBridge158")
private external fun kniBridge158(p0: NativePtr, p1: Int): NativePtr
@SymbolName("sdl_kniBridge159")
private external fun kniBridge159(p0: NativePtr, p1: Int): NativePtr
...
private external fun kniBridge162(p0: NativePtr, p1: NativePtr, p2: Int): NativePtr
@SymbolName("sdl_kniBridge163")
private external fun kniBridge163(p0: NativePtr): UByte
@SymbolName("sdl_kniBridge164")
private external fun kniBridge164(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge165")
private external fun kniBridge165(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge166")
private external fun kniBridge166(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge167")
private external fun kniBridge167(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge168")
private external fun kniBridge168(p0: NativePtr): ULong
@SymbolName("sdl_kniBridge169")
private external fun kniBridge169(p0: NativePtr): ULong
@SymbolName("sdl_kniBridge170")
private external fun kniBridge170(p0: NativePtr, p1: UByte): ULong
@SymbolName("sdl_kniBridge171")
private external fun kniBridge171(p0: NativePtr, p1: UShort): ULong
@SymbolName("sdl_kniBridge172")
private external fun kniBridge172(p0: NativePtr, p1: UShort): ULong
@SymbolName("sdl_kniBridge173")
private external fun kniBridge173(p0: NativePtr, p1: UInt): ULong
@SymbolName("sdl_kniBridge174")
private external fun kniBridge174(p0: NativePtr, p1: UInt): ULong
@SymbolName("sdl_kniBridge175")
private external fun kniBridge175(p0: NativePtr, p1: ULong): ULong
@SymbolName("sdl_kniBridge176")
private external fun kniBridge176(p0: NativePtr, p1: ULong): ULong
...
private external fun kniBridge180(): Unit
@SymbolName("sdl_kniBridge181")
private external fun kniBridge181(): NativePtr
@SymbolName("sdl_kniBridge182")
private external fun kniBridge182(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge183")
private external fun kniBridge183(p0: Int): Int
@SymbolName("sdl_kniBridge184")
private external fun kniBridge184(p0: Int, p1: Int): NativePtr
@SymbolName("sdl_kniBridge185")
private external fun kniBridge185(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr, p4: Int): UInt
@SymbolName("sdl_kniBridge186")
private external fun kniBridge186(): UInt
@SymbolName("sdl_kniBridge187")
private external fun kniBridge187(p0: UInt): UInt
@SymbolName("sdl_kniBridge188")
private external fun kniBridge188(p0: Int): Unit
@SymbolName("sdl_kniBridge189")
private external fun kniBridge189(p0: UInt, p1: Int): Unit
@SymbolName("sdl_kniBridge190")
private external fun kniBridge190(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr, p4: NativePtr): NativePtr
@SymbolName("sdl_kniBridge191")
private external fun kniBridge191(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge192")
private external fun kniBridge192(p0: NativePtr, p1: UShort, p2: UByte, p3: Int, p4: UShort, p5: UByte, p6: Int): Int
@SymbolName("sdl_kniBridge193")
private external fun kniBridge193(p0: NativePtr): Int
@SymbolName("sdl_kniBridge194")
private external fun kniBridge194(p0: UShort, p1: UByte, p2: Int, p3: UShort, p4: UByte, p5: Int): NativePtr
@SymbolName("sdl_kniBridge195")
private external fun kniBridge195(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge196")
private external fun kniBridge196(p0: NativePtr, p1: NativePtr, p2: Int): Int
...
private external fun kniBridge201(p0: NativePtr, p1: NativePtr, p2: UInt, p3: Int): Unit
@SymbolName("sdl_kniBridge202")
private external fun kniBridge202(p0: NativePtr, p1: NativePtr, p2: UShort, p3: UInt, p4: Int): Unit
@SymbolName("sdl_kniBridge203")
private external fun kniBridge203(p0: UInt, p1: NativePtr, p2: UInt): Int
@SymbolName("sdl_kniBridge204")
private external fun kniBridge204(p0: UInt, p1: NativePtr, p2: UInt): UInt
@SymbolName("sdl_kniBridge205")
private external fun kniBridge205(p0: UInt): UInt
@SymbolName("sdl_kniBridge206")
private external fun kniBridge206(p0: UInt): Unit
@SymbolName("sdl_kniBridge207")
private external fun kniBridge207(): Unit
@SymbolName("sdl_kniBridge208")
private external fun kniBridge208(p0: UInt): Unit
@SymbolName("sdl_kniBridge209")
private external fun kniBridge209(): Unit
@SymbolName("sdl_kniBridge210")
private external fun kniBridge210(p0: UInt): Unit
@SymbolName("sdl_kniBridge211")
private external fun kniBridge211(): Unit
@SymbolName("sdl_kniBridge212")
private external fun kniBridge212(p0: UInt): Unit
...
private external fun kniBridge216(): Int
@SymbolName("sdl_kniBridge217")
private external fun kniBridge217(): Int
@SymbolName("sdl_kniBridge218")
private external fun kniBridge218(): UInt
@SymbolName("sdl_kniBridge219")
private external fun kniBridge219(): UInt
@SymbolName("sdl_kniBridge220")
private external fun kniBridge220(): UInt
@SymbolName("sdl_kniBridge221")
private external fun kniBridge221(): UInt
@SymbolName("sdl_kniBridge222")
private external fun kniBridge222(): UInt
...
private external fun kniBridge231(): Int
@SymbolName("sdl_kniBridge232")
private external fun kniBridge232(p0: UInt): NativePtr
@SymbolName("sdl_kniBridge233")
private external fun kniBridge233(p0: UInt, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr, p5: NativePtr): UInt
@SymbolName("sdl_kniBridge234")
private external fun kniBridge234(p0: Int, p1: UInt, p2: UInt, p3: UInt, p4: UInt): UInt
@SymbolName("sdl_kniBridge235")
private external fun kniBridge235(p0: UInt): NativePtr
@SymbolName("sdl_kniBridge236")
private external fun kniBridge236(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge237")
private external fun kniBridge237(p0: Int): NativePtr
@SymbolName("sdl_kniBridge238")
private external fun kniBridge238(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge239")
private external fun kniBridge239(p0: NativePtr, p1: NativePtr, p2: Int, p3: Int): Int
@SymbolName("sdl_kniBridge240")
private external fun kniBridge240(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge241")
private external fun kniBridge241(p0: NativePtr, p1: UByte, p2: UByte, p3: UByte): UInt
@SymbolName("sdl_kniBridge242")
private external fun kniBridge242(p0: NativePtr, p1: UByte, p2: UByte, p3: UByte, p4: UByte): UInt
@SymbolName("sdl_kniBridge243")
private external fun kniBridge243(p0: UInt, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Unit
@SymbolName("sdl_kniBridge244")
private external fun kniBridge244(p0: UInt, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr, p5: NativePtr): Unit
@SymbolName("sdl_kniBridge245")
private external fun kniBridge245(p0: Float, p1: NativePtr): Unit
@SymbolName("sdl_kniBridge246")
private external fun kniBridge246(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge247")
private external fun kniBridge247(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge248")
private external fun kniBridge248(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge249")
private external fun kniBridge249(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge250")
private external fun kniBridge250(p0: NativePtr, p1: NativePtr, p2: NativePtr): UInt
...
private external fun kniBridge252(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): UInt
@SymbolName("sdl_kniBridge253")
private external fun kniBridge253(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): UInt
@SymbolName("sdl_kniBridge254")
private external fun kniBridge254(p0: UInt, p1: UInt, p2: UInt, p3: UInt, p4: UInt, p5: UInt): UInt
@SymbolName("sdl_kniBridge255")
private external fun kniBridge255(p0: UInt, p1: Int, p2: Int, p3: Int, p4: UInt, p5: UInt, p6: UInt, p7: UInt): NativePtr
@SymbolName("sdl_kniBridge256")
private external fun kniBridge256(p0: UInt, p1: Int, p2: Int, p3: Int, p4: UInt): NativePtr
@SymbolName("sdl_kniBridge257")
private external fun kniBridge257(p0: NativePtr, p1: Int, p2: Int, p3: Int, p4: Int, p5: UInt, p6: UInt, p7: UInt, p8: UInt): NativePtr
@SymbolName("sdl_kniBridge258")
private external fun kniBridge258(p0: NativePtr, p1: Int, p2: Int, p3: Int, p4: Int, p5: UInt): NativePtr
@SymbolName("sdl_kniBridge259")
private external fun kniBridge259(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge260")
private external fun kniBridge260(p0: NativePtr, p1: NativePtr): Int
...
private external fun kniBridge263(p0: NativePtr, p1: Int): NativePtr
@SymbolName("sdl_kniBridge264")
private external fun kniBridge264(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge265")
private external fun kniBridge265(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge266")
private external fun kniBridge266(p0: NativePtr, p1: Int, p2: UInt): Int
@SymbolName("sdl_kniBridge267")
private external fun kniBridge267(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge268")
private external fun kniBridge268(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge269")
private external fun kniBridge269(p0: NativePtr, p1: UByte, p2: UByte, p3: UByte): Int
@SymbolName("sdl_kniBridge270")
private external fun kniBridge270(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge271")
private external fun kniBridge271(p0: NativePtr, p1: UByte): Int
@SymbolName("sdl_kniBridge272")
private external fun kniBridge272(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge273")
private external fun kniBridge273(p0: NativePtr, p1: UInt): Int
@SymbolName("sdl_kniBridge274")
private external fun kniBridge274(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge275")
private external fun kniBridge275(p0: NativePtr, p1: NativePtr): UInt
...
private external fun kniBridge278(p0: NativePtr, p1: NativePtr, p2: UInt): NativePtr
@SymbolName("sdl_kniBridge279")
private external fun kniBridge279(p0: NativePtr, p1: UInt, p2: UInt): NativePtr
@SymbolName("sdl_kniBridge280")
private external fun kniBridge280(p0: Int, p1: Int, p2: UInt, p3: NativePtr, p4: Int, p5: UInt, p6: NativePtr, p7: Int): Int
@SymbolName("sdl_kniBridge281")
private external fun kniBridge281(p0: NativePtr, p1: NativePtr, p2: UInt): Int
@SymbolName("sdl_kniBridge282")
private external fun kniBridge282(p0: NativePtr, p1: NativePtr, p2: Int, p3: UInt): Int
@SymbolName("sdl_kniBridge283")
private external fun kniBridge283(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge284")
private external fun kniBridge284(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge285")
private external fun kniBridge285(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge286")
private external fun kniBridge286(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge287")
private external fun kniBridge287(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge288")
private external fun kniBridge288(p0: UInt): Unit
@SymbolName("sdl_kniBridge289")
private external fun kniBridge289(): UInt
@SymbolName("sdl_kniBridge290")
private external fun kniBridge290(p0: Int, p1: Int): UInt
@SymbolName("sdl_kniBridge291")
private external fun kniBridge291(): Int
@SymbolName("sdl_kniBridge292")
private external fun kniBridge292(p0: Int): NativePtr
@SymbolName("sdl_kniBridge293")
private external fun kniBridge293(p0: NativePtr): Int
@SymbolName("sdl_kniBridge294")
private external fun kniBridge294(): Unit
@SymbolName("sdl_kniBridge295")
private external fun kniBridge295(): NativePtr
@SymbolName("sdl_kniBridge296")
private external fun kniBridge296(): Int
@SymbolName("sdl_kniBridge297")
private external fun kniBridge297(p0: Int): NativePtr
@SymbolName("sdl_kniBridge298")
private external fun kniBridge298(p0: Int, p1: NativePtr): Int
@SymbolName("sdl_kniBridge299")
private external fun kniBridge299(p0: Int, p1: NativePtr): Int
@SymbolName("sdl_kniBridge300")
private external fun kniBridge300(p0: Int, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge301")
private external fun kniBridge301(p0: Int): UInt
@SymbolName("sdl_kniBridge302")
private external fun kniBridge302(p0: Int): Int
@SymbolName("sdl_kniBridge303")
private external fun kniBridge303(p0: Int, p1: Int, p2: NativePtr): Int
@SymbolName("sdl_kniBridge304")
private external fun kniBridge304(p0: Int, p1: NativePtr): Int
@SymbolName("sdl_kniBridge305")
private external fun kniBridge305(p0: Int, p1: NativePtr): Int
@SymbolName("sdl_kniBridge306")
private external fun kniBridge306(p0: Int, p1: NativePtr, p2: NativePtr): NativePtr
@SymbolName("sdl_kniBridge307")
private external fun kniBridge307(p0: NativePtr): Int
@SymbolName("sdl_kniBridge308")
private external fun kniBridge308(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge309")
private external fun kniBridge309(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge310")
private external fun kniBridge310(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge311")
private external fun kniBridge311(p0: NativePtr, p1: Int, p2: Int, p3: Int, p4: Int, p5: UInt): NativePtr
...
private external fun kniBridge314(p0: UInt): NativePtr
@SymbolName("sdl_kniBridge315")
private external fun kniBridge315(p0: NativePtr): UInt
...
private external fun kniBridge321(p0: NativePtr, p1: Int, p2: Int): Unit
@SymbolName("sdl_kniBridge322")
private external fun kniBridge322(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
@SymbolName("sdl_kniBridge323")
private external fun kniBridge323(p0: NativePtr, p1: Int, p2: Int): Unit
...
private external fun kniBridge325(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Int
@SymbolName("sdl_kniBridge326")
private external fun kniBridge326(p0: NativePtr, p1: Int, p2: Int): Unit
@SymbolName("sdl_kniBridge327")
private external fun kniBridge327(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
@SymbolName("sdl_kniBridge328")
private external fun kniBridge328(p0: NativePtr, p1: Int, p2: Int): Unit
@SymbolName("sdl_kniBridge329")
private external fun kniBridge329(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
@SymbolName("sdl_kniBridge330")
private external fun kniBridge330(p0: NativePtr, p1: UInt): Unit
@SymbolName("sdl_kniBridge331")
private external fun kniBridge331(p0: NativePtr, p1: UInt): Unit
@SymbolName("sdl_kniBridge332")
private external fun kniBridge332(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge333")
private external fun kniBridge333(p0: NativePtr): Unit
...
private external fun kniBridge336(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge337")
private external fun kniBridge337(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge338")
private external fun kniBridge338(p0: NativePtr, p1: UInt): Int
...
private external fun kniBridge341(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge342")
private external fun kniBridge342(p0: NativePtr, p1: UInt): Unit
@SymbolName("sdl_kniBridge343")
private external fun kniBridge343(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge344")
private external fun kniBridge344(): NativePtr
@SymbolName("sdl_kniBridge345")
private external fun kniBridge345(p0: NativePtr, p1: Float): Int
@SymbolName("sdl_kniBridge346")
private external fun kniBridge346(p0: NativePtr): Float
@SymbolName("sdl_kniBridge347")
private external fun kniBridge347(p0: NativePtr, p1: Float): Int
@SymbolName("sdl_kniBridge348")
private external fun kniBridge348(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge349")
private external fun kniBridge349(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge350")
private external fun kniBridge350(p0: NativePtr): Int
@SymbolName("sdl_kniBridge351")
private external fun kniBridge351(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge352")
private external fun kniBridge352(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
...
private external fun kniBridge355(): UInt
@SymbolName("sdl_kniBridge356")
private external fun kniBridge356(): Unit
...
private external fun kniBridge359(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge360")
private external fun kniBridge360(): Unit
@SymbolName("sdl_kniBridge361")
private external fun kniBridge361(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge362")
private external fun kniBridge362(): Unit
@SymbolName("sdl_kniBridge363")
private external fun kniBridge363(p0: UInt, p1: Int): Int
@SymbolName("sdl_kniBridge364")
private external fun kniBridge364(p0: UInt, p1: NativePtr): Int
@SymbolName("sdl_kniBridge365")
private external fun kniBridge365(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge366")
private external fun kniBridge366(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge367")
private external fun kniBridge367(): NativePtr
@SymbolName("sdl_kniBridge368")
private external fun kniBridge368(): NativePtr
@SymbolName("sdl_kniBridge369")
private external fun kniBridge369(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
@SymbolName("sdl_kniBridge370")
private external fun kniBridge370(p0: Int): Int
@SymbolName("sdl_kniBridge371")
private external fun kniBridge371(): Int
...
private external fun kniBridge374(): NativePtr
@SymbolName("sdl_kniBridge375")
private external fun kniBridge375(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge376")
private external fun kniBridge376(): UInt
@SymbolName("sdl_kniBridge377")
private external fun kniBridge377(p0: UInt): Unit
@SymbolName("sdl_kniBridge378")
private external fun kniBridge378(p0: UInt): Int
@SymbolName("sdl_kniBridge379")
private external fun kniBridge379(p0: Int): UInt
@SymbolName("sdl_kniBridge380")
private external fun kniBridge380(p0: UInt): NativePtr
@SymbolName("sdl_kniBridge381")
private external fun kniBridge381(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge382")
private external fun kniBridge382(p0: Int): NativePtr
@SymbolName("sdl_kniBridge383")
private external fun kniBridge383(p0: NativePtr): Int
@SymbolName("sdl_kniBridge384")
private external fun kniBridge384(): Unit
@SymbolName("sdl_kniBridge385")
private external fun kniBridge385(): UInt
@SymbolName("sdl_kniBridge386")
private external fun kniBridge386(): Unit
@SymbolName("sdl_kniBridge387")
private external fun kniBridge387(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge388")
private external fun kniBridge388(): UInt
@SymbolName("sdl_kniBridge389")
private external fun kniBridge389(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge390")
private external fun kniBridge390(): NativePtr
@SymbolName("sdl_kniBridge391")
private external fun kniBridge391(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge392")
private external fun kniBridge392(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge393")
private external fun kniBridge393(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge394")
private external fun kniBridge394(p0: NativePtr, p1: Int, p2: Int): Unit
@SymbolName("sdl_kniBridge395")
private external fun kniBridge395(p0: Int, p1: Int): Int
@SymbolName("sdl_kniBridge396")
private external fun kniBridge396(p0: UInt): Int
@SymbolName("sdl_kniBridge397")
private external fun kniBridge397(p0: UInt): Int
@SymbolName("sdl_kniBridge398")
private external fun kniBridge398(): UInt
@SymbolName("sdl_kniBridge399")
private external fun kniBridge399(p0: NativePtr, p1: NativePtr, p2: Int, p3: Int, p4: Int, p5: Int): NativePtr
@SymbolName("sdl_kniBridge400")
private external fun kniBridge400(p0: NativePtr, p1: Int, p2: Int): NativePtr
@SymbolName("sdl_kniBridge401")
private external fun kniBridge401(p0: UInt): NativePtr
@SymbolName("sdl_kniBridge402")
private external fun kniBridge402(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge403")
private external fun kniBridge403(): NativePtr
@SymbolName("sdl_kniBridge404")
private external fun kniBridge404(): NativePtr
@SymbolName("sdl_kniBridge405")
private external fun kniBridge405(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge406")
private external fun kniBridge406(p0: Int): Int
@SymbolName("sdl_kniBridge407")
private external fun kniBridge407(): Unit
@SymbolName("sdl_kniBridge408")
private external fun kniBridge408(): Unit
@SymbolName("sdl_kniBridge409")
private external fun kniBridge409(): Int
@SymbolName("sdl_kniBridge410")
private external fun kniBridge410(p0: Int): NativePtr
@SymbolName("sdl_kniBridge411")
private external fun kniBridge411(p0: Int): Int
@SymbolName("sdl_kniBridge412")
private external fun kniBridge412(p0: Int, p1: NativePtr): Unit
@SymbolName("sdl_kniBridge413")
private external fun kniBridge413(p0: Int): UShort
@SymbolName("sdl_kniBridge414")
private external fun kniBridge414(p0: Int): UShort
@SymbolName("sdl_kniBridge415")
private external fun kniBridge415(p0: Int): UShort
@SymbolName("sdl_kniBridge416")
private external fun kniBridge416(p0: Int): UInt
...
private external fun kniBridge419(p0: Int): NativePtr
...
private external fun kniBridge423(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge424")
private external fun kniBridge424(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge425")
private external fun kniBridge425(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge426")
private external fun kniBridge426(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge427")
private external fun kniBridge427(p0: NativePtr, p1: NativePtr, p2: Int): Unit
@SymbolName("sdl_kniBridge428")
private external fun kniBridge428(p0: NativePtr, p1: NativePtr): Unit
@SymbolName("sdl_kniBridge429")
private external fun kniBridge429(p0: NativePtr): UInt
...
private external fun kniBridge434(p0: NativePtr): Int
@SymbolName("sdl_kniBridge435")
private external fun kniBridge435(): Unit
@SymbolName("sdl_kniBridge436")
private external fun kniBridge436(p0: Int): Int
@SymbolName("sdl_kniBridge437")
private external fun kniBridge437(p0: NativePtr, p1: Int): Short
@SymbolName("sdl_kniBridge438")
private external fun kniBridge438(p0: NativePtr, p1: Int, p2: NativePtr): UInt
@SymbolName("sdl_kniBridge439")
private external fun kniBridge439(p0: NativePtr, p1: Int): UByte
@SymbolName("sdl_kniBridge440")
private external fun kniBridge440(p0: NativePtr, p1: Int, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge441")
private external fun kniBridge441(p0: NativePtr, p1: Int): UByte
@SymbolName("sdl_kniBridge442")
private external fun kniBridge442(p0: NativePtr, p1: UShort, p2: UShort, p3: UInt): Int
@SymbolName("sdl_kniBridge443")
private external fun kniBridge443(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge444")
private external fun kniBridge444(p0: NativePtr): Int
@SymbolName("sdl_kniBridge445")
private external fun kniBridge445(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge446")
private external fun kniBridge446(p0: NativePtr): Int
@SymbolName("sdl_kniBridge447")
private external fun kniBridge447(): Int
@SymbolName("sdl_kniBridge448")
private external fun kniBridge448(p0: Int): NativePtr
...
private external fun kniBridge451(p0: Int): UInt
@SymbolName("sdl_kniBridge452")
private external fun kniBridge452(p0: Int): NativePtr
@SymbolName("sdl_kniBridge453")
private external fun kniBridge453(p0: Int): NativePtr
@SymbolName("sdl_kniBridge454")
private external fun kniBridge454(p0: Int): NativePtr
@SymbolName("sdl_kniBridge455")
private external fun kniBridge455(p0: Int): NativePtr
@SymbolName("sdl_kniBridge456")
private external fun kniBridge456(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge457")
private external fun kniBridge457(p0: NativePtr): Int
@SymbolName("sdl_kniBridge458")
private external fun kniBridge458(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge459")
private external fun kniBridge459(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge460")
private external fun kniBridge460(p0: NativePtr): UShort
@SymbolName("sdl_kniBridge461")
private external fun kniBridge461(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge462")
private external fun kniBridge462(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge463")
private external fun kniBridge463(p0: Int): Int
@SymbolName("sdl_kniBridge464")
private external fun kniBridge464(): Unit
@SymbolName("sdl_kniBridge465")
private external fun kniBridge465(p0: NativePtr): Int
@SymbolName("sdl_kniBridge466")
private external fun kniBridge466(p0: Int): NativePtr
...
private external fun kniBridge468(p0: NativePtr, p1: Int): Short
@SymbolName("sdl_kniBridge469")
private external fun kniBridge469(p0: NativePtr): Int
@SymbolName("sdl_kniBridge470")
private external fun kniBridge470(p0: Int): NativePtr
...
private external fun kniBridge472(p0: NativePtr, p1: Int): UByte
@SymbolName("sdl_kniBridge473")
private external fun kniBridge473(p0: NativePtr, p1: UShort, p2: UShort, p3: UInt): Int
...
private external fun kniBridge476(p0: Int): Long
@SymbolName("sdl_kniBridge477")
private external fun kniBridge477(p0: Long): Int
@SymbolName("sdl_kniBridge478")
private external fun kniBridge478(p0: Long, p1: Int): NativePtr
@SymbolName("sdl_kniBridge479")
private external fun kniBridge479(p0: Long): Int
@SymbolName("sdl_kniBridge480")
private external fun kniBridge480(p0: NativePtr): Int
@SymbolName("sdl_kniBridge481")
private external fun kniBridge481(p0: Long, p1: NativePtr): Int
@SymbolName("sdl_kniBridge482")
private external fun kniBridge482(p0: Long, p1: NativePtr): Int
@SymbolName("sdl_kniBridge483")
private external fun kniBridge483(): Unit
@SymbolName("sdl_kniBridge484")
private external fun kniBridge484(p0: NativePtr, p1: Int, p2: UInt, p3: UInt, p4: UInt): Int
@SymbolName("sdl_kniBridge485")
private external fun kniBridge485(p0: UInt): UInt
@SymbolName("sdl_kniBridge486")
private external fun kniBridge486(p0: UInt, p1: UInt): UInt
@SymbolName("sdl_kniBridge487")
private external fun kniBridge487(p0: UInt): Unit
@SymbolName("sdl_kniBridge488")
private external fun kniBridge488(p0: UInt, p1: UInt): Unit
...
private external fun kniBridge491(p0: NativePtr, p1: Int): Int
...
private external fun kniBridge494(p0: NativePtr, p1: NativePtr): UInt
...
private external fun kniBridge498(p0: UInt, p1: Int): UByte
@SymbolName("sdl_kniBridge499")
private external fun kniBridge499(p0: Int): UInt
@SymbolName("sdl_kniBridge500")
private external fun kniBridge500(): NativePtr
@SymbolName("sdl_kniBridge501")
private external fun kniBridge501(p0: NativePtr, p1: NativePtr): NativePtr
@SymbolName("sdl_kniBridge502")
private external fun kniBridge502(): Int
@SymbolName("sdl_kniBridge503")
private external fun kniBridge503(p0: Int): NativePtr
@SymbolName("sdl_kniBridge504")
private external fun kniBridge504(p0: Int): NativePtr
@SymbolName("sdl_kniBridge505")
private external fun kniBridge505(p0: Int): Int
@SymbolName("sdl_kniBridge506")
private external fun kniBridge506(p0: NativePtr): Int
@SymbolName("sdl_kniBridge507")
private external fun kniBridge507(): Int
@SymbolName("sdl_kniBridge508")
private external fun kniBridge508(): NativePtr
...
private external fun kniBridge514(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge515")
private external fun kniBridge515(p0: NativePtr): Int
@SymbolName("sdl_kniBridge516")
private external fun kniBridge516(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge517")
private external fun kniBridge517(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge518")
private external fun kniBridge518(p0: NativePtr, p1: Int, p2: NativePtr): Int
@SymbolName("sdl_kniBridge519")
private external fun kniBridge519(p0: NativePtr, p1: Int, p2: UInt): Int
@SymbolName("sdl_kniBridge520")
private external fun kniBridge520(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge521")
private external fun kniBridge521(p0: NativePtr, p1: Int): Unit
@SymbolName("sdl_kniBridge522")
private external fun kniBridge522(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge523")
private external fun kniBridge523(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge524")
private external fun kniBridge524(p0: NativePtr, p1: Int): Int
@SymbolName("sdl_kniBridge525")
private external fun kniBridge525(p0: NativePtr): Int
@SymbolName("sdl_kniBridge526")
private external fun kniBridge526(p0: NativePtr): Int
...
private external fun kniBridge529(p0: NativePtr): Int
@SymbolName("sdl_kniBridge530")
private external fun kniBridge530(p0: NativePtr, p1: Float, p2: UInt): Int
@SymbolName("sdl_kniBridge531")
private external fun kniBridge531(p0: NativePtr): Int
@SymbolName("sdl_kniBridge532")
private external fun kniBridge532(p0: NativePtr, p1: NativePtr, p2: UInt): UInt
@SymbolName("sdl_kniBridge533")
private external fun kniBridge533(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge534")
private external fun kniBridge534(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge535")
private external fun kniBridge535(p0: NativePtr, p1: UInt): UInt
...
private external fun kniBridge537(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
@SymbolName("sdl_kniBridge538")
private external fun kniBridge538(): Unit
@SymbolName("sdl_kniBridge539")
private external fun kniBridge539(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge540")
private external fun kniBridge540(p0: NativePtr, p1: NativePtr): NativePtr
@SymbolName("sdl_kniBridge541")
private external fun kniBridge541(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge542")
private external fun kniBridge542(p0: UInt): Unit
@SymbolName("sdl_kniBridge543")
private external fun kniBridge543(p0: Int, p1: UInt): Unit
@SymbolName("sdl_kniBridge544")
private external fun kniBridge544(p0: Int): UInt
@SymbolName("sdl_kniBridge545")
private external fun kniBridge545(): Unit
@SymbolName("sdl_kniBridge546")
private external fun kniBridge546(p0: Int, p1: UInt, p2: NativePtr, p3: NativePtr): Unit
...
private external fun kniBridge550(p0: UInt, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge551")
private external fun kniBridge551(p0: NativePtr, p1: NativePtr): UInt
@SymbolName("sdl_kniBridge552")
private external fun kniBridge552(): Int
@SymbolName("sdl_kniBridge553")
private external fun kniBridge553(p0: Int, p1: NativePtr): Int
@SymbolName("sdl_kniBridge554")
private external fun kniBridge554(p0: Int, p1: Int, p2: UInt, p3: NativePtr, p4: NativePtr): Int
@SymbolName("sdl_kniBridge555")
private external fun kniBridge555(p0: NativePtr, p1: Int, p2: UInt): NativePtr
@SymbolName("sdl_kniBridge556")
private external fun kniBridge556(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge557")
private external fun kniBridge557(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge558")
private external fun kniBridge558(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge559")
private external fun kniBridge559(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
@SymbolName("sdl_kniBridge560")
private external fun kniBridge560(p0: NativePtr, p1: UInt, p2: Int, p3: Int, p4: Int): NativePtr
@SymbolName("sdl_kniBridge561")
private external fun kniBridge561(p0: NativePtr, p1: NativePtr): NativePtr
@SymbolName("sdl_kniBridge562")
private external fun kniBridge562(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Int
@SymbolName("sdl_kniBridge563")
private external fun kniBridge563(p0: NativePtr, p1: UByte, p2: UByte, p3: UByte): Int
@SymbolName("sdl_kniBridge564")
private external fun kniBridge564(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge565")
private external fun kniBridge565(p0: NativePtr, p1: UByte): Int
@SymbolName("sdl_kniBridge566")
private external fun kniBridge566(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge567")
private external fun kniBridge567(p0: NativePtr, p1: UInt): Int
@SymbolName("sdl_kniBridge568")
private external fun kniBridge568(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge569")
private external fun kniBridge569(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int): Int
@SymbolName("sdl_kniBridge570")
private external fun kniBridge570(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: Int, p4: NativePtr, p5: Int, p6: NativePtr, p7: Int): Int
@SymbolName("sdl_kniBridge571")
private external fun kniBridge571(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge572")
private external fun kniBridge572(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge573")
private external fun kniBridge573(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge574")
private external fun kniBridge574(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge575")
private external fun kniBridge575(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge576")
private external fun kniBridge576(p0: NativePtr, p1: Int, p2: Int): Int
@SymbolName("sdl_kniBridge577")
private external fun kniBridge577(p0: NativePtr, p1: NativePtr, p2: NativePtr): Unit
@SymbolName("sdl_kniBridge578")
private external fun kniBridge578(p0: NativePtr, p1: UInt): Int
...
private external fun kniBridge584(p0: NativePtr): UInt
@SymbolName("sdl_kniBridge585")
private external fun kniBridge585(p0: NativePtr, p1: Float, p2: Float): Int
...
private external fun kniBridge587(p0: NativePtr, p1: UByte, p2: UByte, p3: UByte, p4: UByte): Int
@SymbolName("sdl_kniBridge588")
private external fun kniBridge588(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: NativePtr): Int
@SymbolName("sdl_kniBridge589")
private external fun kniBridge589(p0: NativePtr, p1: UInt): Int
@SymbolName("sdl_kniBridge590")
private external fun kniBridge590(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge591")
private external fun kniBridge591(p0: NativePtr): Int
@SymbolName("sdl_kniBridge592")
private external fun kniBridge592(p0: NativePtr, p1: Int, p2: Int): Int
@SymbolName("sdl_kniBridge593")
private external fun kniBridge593(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge594")
private external fun kniBridge594(p0: NativePtr, p1: Int, p2: Int, p3: Int, p4: Int): Int
@SymbolName("sdl_kniBridge595")
private external fun kniBridge595(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge596")
private external fun kniBridge596(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge597")
private external fun kniBridge597(p0: NativePtr, p1: NativePtr, p2: Int): Int
...
private external fun kniBridge600(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr): Int
@SymbolName("sdl_kniBridge601")
private external fun kniBridge601(p0: NativePtr, p1: NativePtr, p2: NativePtr, p3: NativePtr, p4: Double, p5: NativePtr, p6: UInt): Int
@SymbolName("sdl_kniBridge602")
private external fun kniBridge602(p0: NativePtr, p1: NativePtr, p2: UInt, p3: NativePtr, p4: Int): Int
@SymbolName("sdl_kniBridge603")
private external fun kniBridge603(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge604")
private external fun kniBridge604(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge605")
private external fun kniBridge605(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge606")
private external fun kniBridge606(p0: NativePtr, p1: NativePtr, p2: NativePtr): Int
@SymbolName("sdl_kniBridge607")
private external fun kniBridge607(p0: NativePtr): Int
@SymbolName("sdl_kniBridge608")
private external fun kniBridge608(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge609")
private external fun kniBridge609(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge610")
private external fun kniBridge610(): Int
@SymbolName("sdl_kniBridge611")
private external fun kniBridge611(p0: Int): NativePtr
@SymbolName("sdl_kniBridge612")
private external fun kniBridge612(p0: Int): Int
@SymbolName("sdl_kniBridge613")
private external fun kniBridge613(p0: Int): Int
@SymbolName("sdl_kniBridge614")
private external fun kniBridge614(p0: Int): Int
@SymbolName("sdl_kniBridge615")
private external fun kniBridge615(p0: Int): NativePtr
@SymbolName("sdl_kniBridge616")
private external fun kniBridge616(p0: Int): NativePtr
@SymbolName("sdl_kniBridge617")
private external fun kniBridge617(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge618")
private external fun kniBridge618(p0: NativePtr): Int
@SymbolName("sdl_kniBridge619")
private external fun kniBridge619(p0: NativePtr): Int
@SymbolName("sdl_kniBridge620")
private external fun kniBridge620(p0: NativePtr): Int
@SymbolName("sdl_kniBridge621")
private external fun kniBridge621(p0: NativePtr, p1: NativePtr, p2: Int): Int
@SymbolName("sdl_kniBridge622")
private external fun kniBridge622(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge623")
private external fun kniBridge623(): Unit
@SymbolName("sdl_kniBridge624")
private external fun kniBridge624(p0: NativePtr, p1: UInt, p2: UInt, p3: UInt, p4: UInt, p5: UInt): NativePtr
...
private external fun kniBridge627(p0: NativePtr, p1: NativePtr): Int
@SymbolName("sdl_kniBridge628")
private external fun kniBridge628(p0: NativePtr, p1: NativePtr): Unit
@SymbolName("sdl_kniBridge629")
private external fun kniBridge629(p0: Int): Int
@SymbolName("sdl_kniBridge630")
private external fun kniBridge630(p0: NativePtr): NativePtr
@SymbolName("sdl_kniBridge631")
private external fun kniBridge631(p0: Int, p1: NativePtr, p2: NativePtr): UInt
@SymbolName("sdl_kniBridge632")
private external fun kniBridge632(): UInt
@SymbolName("sdl_kniBridge633")
private external fun kniBridge633(): UInt
@SymbolName("sdl_kniBridge634")
private external fun kniBridge634(): ULong
@SymbolName("sdl_kniBridge635")
private external fun kniBridge635(): ULong
@SymbolName("sdl_kniBridge636")
private external fun kniBridge636(p0: UInt): Unit
@SymbolName("sdl_kniBridge637")
private external fun kniBridge637(p0: UInt, p1: NativePtr, p2: NativePtr): Int
@SymbolName("sdl_kniBridge638")
private external fun kniBridge638(p0: Int): UInt
@SymbolName("sdl_kniBridge639")
private external fun kniBridge639(p0: NativePtr): Unit
@SymbolName("sdl_kniBridge640")
private external fun kniBridge640(): NativePtr
@SymbolName("sdl_kniBridge641")
private external fun kniBridge641(): Int
@SymbolName("sdl_kniBridge642")
private external fun kniBridge642(p0: UInt): Int
@SymbolName("sdl_kniBridge643")
private external fun kniBridge643(p0: UInt): Int
@SymbolName("sdl_kniBridge644")
private external fun kniBridge644(p0: UInt): Unit
@SymbolName("sdl_kniBridge645")
private external fun kniBridge645(p0: UInt): UInt
@SymbolName("sdl_kniBridge646")
private external fun kniBridge646(): Unit
@SymbolName("sdl_kniBridge647")
private external fun kniBridge647(): NativePtr
@SymbolName("sdl_kniBridge648")
private external fun kniBridge648(): NativePtr
@SymbolName("sdl_kniBridge649")
private external fun kniBridge649(): NativePtr
@SymbolName("sdl_kniBridge650")
private external fun kniBridge650(): NativePtr
