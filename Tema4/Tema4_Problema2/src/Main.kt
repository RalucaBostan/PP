...
fun main(args : Array<String>){
    ...
    val tara = Tara("Romania", capitala, judete);
    file.writeText("$tara");
    ...
    toate_comunele.forEach {
        println("${it.GetNumeComuna()} este capitala : ${it.accept(capital_visitor)}")
    }
    ...
    judete.forEach {
        println("${it.GetNumeJudet()} este capitala : ${it.accept(capital_visitor)}")
    }

    println("${capitala.getNumeCapitala()} este capitala : ${capitala.accept(capital_visitor)}")
